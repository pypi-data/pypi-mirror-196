...
from franky.visualization import Visualizer
from .base_loop import BaseLoop
from .checkpoint import (_load_checkpoint, _load_checkpoint_to_model, find_latest_checkpoint, get_state_dict,
...
class Runner:
    ...
    Examples:
        >>> from franky.runner import Runner
        >>> cfg = dict(
    ...
    def from_cfg(cls, cfg: ConfigType) -> 'Runner':
        ...
        runner = cls(
            ...
            default_scope=cfg.get('default_scope', 'franky'),
    ...
    def build_logger(self,
        ...
        Args:
            ...
            log_file (str, optional): Path of filename to save log.
                Defaults to None.
            **kwargs: Remaining parameters passed to ``OPLogger``.

        Returns:
            OPLogger: A OPLogger object build from ``logger``.
        """
        if log_file is None:
    ...
    def build_visualizer(
            self,
            visualizer: Optional[Union[Visualizer, Dict]] = None) -> Visualizer:
    ...
    def wrap_model(
        ...
        """Wrap the model to :obj:``OPDistributedDataParallel`` or other custom
    ...
    def build_param_scheduler(
            self, scheduler: Union[_ParamScheduler, Dict, List]) -> ParamSchedulerType:
        ...
        Examples:
            ...
            >>> schedulers
            [<franky.optim.scheduler.lr_scheduler.MultiStepLR at 0x7f70f6966290>]  # noqa: E501
            ...
            >>> schedulers = runner.build_param_scheduler(scheduler_cfg)
            >>> schedulers
            [<franky.optim.scheduler.lr_scheduler.MultiStepLR at 0x7f70f60dd3d0>,  # noqa: E501
            <franky.optim.scheduler.lr_scheduler.StepLR at 0x7f70f6eb6150>]
    ...
    def save_checkpoint(
        ...
        meta.update(
            ...
            franky_version=franky.__version__ + get_git_hash())
    ...
    def _check_scheduler_cfg(
            self, param_scheduler: Optional[Union[dict, list, _ParamScheduler]]) -> None:
        ...
        Examples:
            ...
            >>> from franky.optim import MultiStepLR
