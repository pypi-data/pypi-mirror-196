...
from franky.registry import HOOKS, MODELS, RUNNERS
...
def build_runner_with_tta(cfg: dict) -> 'Runner':
    ...
    """
    assert hasattr(cfg, 'tta_model'), ('please make sure tta_model is defined in your config.')
    assert hasattr(cfg, 'tta_pipeline'), ('please make sure tta_pipeline is defined in your config.')
