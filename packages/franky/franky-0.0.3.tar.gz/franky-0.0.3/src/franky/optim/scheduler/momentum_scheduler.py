from franky.registry import PARAM_SCHEDULERS
from .param_scheduler import (ConstantParamScheduler, CosineAnnealingParamScheduler, CosineRestartParamScheduler,
                              ...
                              PolyParamScheduler, ReduceOnPlateauParamScheduler, StepParamScheduler)
...
class MomentumSchedulerMixin:
    ...
    def __init__(self, optimizer, *args, **kwargs):
        ...
        if 'momentum' in optimizer.defaults:
            ...
            raise ValueError('optimizer must support momentum when using momentum scheduler')
...
@PARAM_SCHEDULERS.register_module()
class CosineAnnealingMomentum(MomentumSchedulerMixin, CosineAnnealingParamScheduler):
...
@PARAM_SCHEDULERS.register_module()
class CosineRestartMomentum(MomentumSchedulerMixin, CosineRestartParamScheduler):
