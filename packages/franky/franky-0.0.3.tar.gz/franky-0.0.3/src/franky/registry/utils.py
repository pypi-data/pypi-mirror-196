...
def count_registered_modules(save_path: Optional[str] = None,
    ...
    """Scan all modules in Franky's root and child registries and dump to
    json.
    ...
    import franky.dataset
    import franky.evaluator
    import franky.hooks
    import franky.model
    import franky.optim
    import franky.runner
    import franky.visualization  # noqa: F401

    registries_info = {}
    # traverse all registries in Franky
