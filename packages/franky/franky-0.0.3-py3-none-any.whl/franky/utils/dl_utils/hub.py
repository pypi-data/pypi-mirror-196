...
if digit_version(TORCH_VERSION) < digit_version('1.7.0'):
    ...
    def load_url(url, model_dir=None, map_location=None, progress=True, check_hash=False, file_name=None):
        ...
        try:
            ...
            if digit_version(TORCH_VERSION) < digit_version('1.5.0'):
                warnings.warn(f'If the error is the same as "{cached_file} is a zip '
