...
from franky.fileio import list_from_file, load
from franky.registry import TRANSFORMS
from franky.utils import is_abs
...
class BaseDataset(Dataset):
    r"""BaseDataset for open source projects.
    ...
    Args:
        ...
        data_prefix (dict): Prefix for training data. Defaults to None.
        ...
        max_refetch (int, optional): If ``Basedataset.prepare_data`` get None.
            The maximum extra number of cycles to get a valid data. Defaults to 1000.
    ...
    def __getitem__(self, idx: int) -> dict:
        """Get the idx-th data information of dataset after
        ...
        for _ in range(self.max_refetch + 1):
            data = self.prepare_data(idx)
            # Broken data or random augmentations may cause the returned data
            # to be None
            if data is None:
    ...
    def load_data_list(self) -> List[dict]:
        ...
        If the annotation file does not follow basedataset,
