...
from franky.fileio import dump, load
from franky.logging import print_log
from franky.utils import check_file_exist, import_modules_from_strings
...
class Config:
    ...
    Examples:
        ...
        >>> cfg.filename
        "/home/username/projects/franky/tests/data/config/a.py"
        >>> cfg.item4
        'test'
        >>> cfg
        "Config [path: /home/username/projects/franky/tests/data/config/a.py]
        :"
    ...
    def _get_cfg_path(cfg_path: str,
        ...
        """
        if '::' in cfg_path:
            raise ValueError(':: is not supported in config')
        else:
