...
class BaseDataElement:
    ...
    groundtruth bboxes), Franky uses the same abstract data interface to
    ...
    characteristics. Therefore, Franky defines the base class
    ...
    OPDetection is assigned by the BaseDataElement to encapsulate all the data
