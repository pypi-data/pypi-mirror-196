...
import franky
from franky.registry import OPTIM_WRAPPERS
...
class ApexOptimWrapper(OptimWrapper):
    ...
    Args:
        ...
        patch_torch_functions (bool, optional): Patch all Torch functions
            and Tensor methods to perform Tensor Core-friendly ops like GEOPs
    ...
    def optim_context(self, model: nn.Module):
        ...
        with super().optim_context(model):
            ...
            if not hasattr(self.optimizer, '_amp_stash'):
                if franky.model.wrappers.is_model_wrapper(model):
                    model = model.module
