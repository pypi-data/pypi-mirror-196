...
import franky
from franky.dist import get_dist_info
from franky.fileio import load, get_file_backend
from franky.logging import print_log
from franky.model import BaseTTAModel, is_model_wrapper
from franky.utils import digit_version
from franky.utils.dl_utils import load_url
...
def get_torchvision_models():
    ...
    if digit_version(torchvision.__version__) < digit_version('0.13.0a0'):
        ...
        json_path = osp.join(franky.__path__[0], 'hub/torchvision_0.12.json')
