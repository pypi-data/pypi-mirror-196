...
class Features(object):
    ...
    attribute_map = {
        ...
        'enhanced_api_key': 'enhanced_api_key',
        'exchange': 'exchange',
    ...
    def __init__(self, auth0=None, change_logging=False, cold_job_logs=False, collections=False, copy_by_reference=True, core_api=True, crawler=False, default_viewer_apps=True, deid_log=False, deid_profile=False, dimse=False, elastic_search_primary=False, enhanced_api_key=False, exchange=False, external_routing=False, gear_access=False, google_analytics=True, healthcare_api=False, job_ask=True, job_tickets=True, ldap_sync=False, multifactor_auth=False, multipart_signed_url=True, multiproject=False, ohif_multi_subject_view=False, ohif_react=False, ohif_react_beta=False, ohif_slice_order=None, ohif_v3=False, ohif_v3_beta=False, open_tracing=False, project_export=False, project_locking=False, reader_tasks=False, rts_sync=False, sentry_logging=None, shared_projects=False, signed_url=False, study_task_status=False, tagging=False, tags_in_lists=True, task_manager_data_views=True, unsafe_login=False, user_jobs=True, userpilot=None, validate_classification=False, virus_scan=False, api_enabled_gear_rules=True):  # noqa: E501
        ...
        if change_logging is not None:
            self.change_logging = change_logging
        ...
        if enhanced_api_key is not None:
            self.enhanced_api_key = enhanced_api_key
    ...
    def change_logging(self):
        ...
        :return: The change_logging of this Features.
        :rtype: bool
        """
        return self._change_logging

    @change_logging.setter
    def change_logging(self, change_logging):
        """Sets the change_logging of this Features.


        :param change_logging: The change_logging of this Features.  # noqa: E501
        :type: bool
        """

        self._change_logging = change_logging
    ...
    @property
    def enhanced_api_key(self):
        """Gets the enhanced_api_key of this Features.


        :return: The enhanced_api_key of this Features.
        :rtype: bool
        """
        return self._enhanced_api_key

    @enhanced_api_key.setter
    def enhanced_api_key(self, enhanced_api_key):
        """Sets the enhanced_api_key of this Features.


        :param enhanced_api_key: The enhanced_api_key of this Features.  # noqa: E501
        :type: bool
        """

        self._enhanced_api_key = enhanced_api_key
    ...
    def user_jobs(self):
        ...
        :return: The user_jobs of this Features.
        :rtype: bool
        """
        return self._user_jobs

    @user_jobs.setter
    def user_jobs(self, user_jobs):
        """Sets the user_jobs of this Features.


        :param user_jobs: The user_jobs of this Features.  # noqa: E501
        :type: bool
        """
