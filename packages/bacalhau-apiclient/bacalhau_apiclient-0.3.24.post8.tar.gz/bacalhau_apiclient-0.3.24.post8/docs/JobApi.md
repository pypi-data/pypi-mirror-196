...
body = swagger_client.CancelRequest() # CancelRequest | 
...
# create an instance of the API class
api_instance = swagger_client.JobApi()
body = swagger_client.EventsRequest() # EventsRequest | Request must specify a `client_id`. To retrieve your `client_id`, you can do the following: (1) submit a dummy job to Bacalhau (or use one you created before), (2) run `bacalhau describe <job-id>` and fetch the `ClientID` field.
...
# create an instance of the API class
api_instance = swagger_client.JobApi()
body = swagger_client.ListRequest() # ListRequest | Set `return_all` to `true` to return all jobs on the network (may degrade performance, use with care!).
...
# create an instance of the API class
api_instance = swagger_client.JobApi()
body = swagger_client.StateRequest() # StateRequest | 
...
# create an instance of the API class
api_instance = swagger_client.JobApi()
body = swagger_client.SubmitRequest() # SubmitRequest | 
