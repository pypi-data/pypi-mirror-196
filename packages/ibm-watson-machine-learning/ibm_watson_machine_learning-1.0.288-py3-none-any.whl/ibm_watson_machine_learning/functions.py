        ...
        **Example**
        ...
        if self._client.WSD:
            ...
            if self._client.CLOUD_PLATFORM_SPACES or self._client.ICP_PLATFORM_SPACES:
                ...
                self._list(function_values, ['GUID', 'NAME', 'CREATED', 'TYPE', 'SPEC_STATE', 'SPEC_REPLACEMENT'],
                ...
                self._list(function_values, ['GUID', 'NAME', 'CREATED', 'TYPE'], limit, _DEFAULT_LIST_LENGTH)
