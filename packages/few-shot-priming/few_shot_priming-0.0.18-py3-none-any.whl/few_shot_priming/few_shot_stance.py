...
def save_splits():
    ...
    path_source = conf["dataset"]["path-root"]
    path_training = conf["experiment"]["path-training"]
    path_validation = conf["experiment"]["path-validation"]
    path_test = conf["experiment"]["path-test"]
