...
def run_experiment_fewshot(splits, offline=True, validate=False, wandb=True):
    """
...
if __name__ == "__main__":
    ...
    if args.validate:
        splits = load_splits()
        run_experiment_fewshot(splits, offline=offline, validate=True, wandb=True)

    if args.test:
        splits = load_splits()
        run_experiment_fewshot(splits, offline=offline, validate=False, wandb=True)
