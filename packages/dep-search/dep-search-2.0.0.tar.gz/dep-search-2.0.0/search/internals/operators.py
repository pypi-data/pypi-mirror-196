...
class SizeGte(ComparisonExpression):
    """Array size expression, syntax: field: {$size: {$gte: <value>}}}."""
    ...
    def eval(self) -> Dict:
        ...
        return {self.field: {self.__type__: {'$gte': self.value}}}


class SizeLte(ComparisonExpression):
    """Array size expression, syntax: field: {$size: {$lte: <value>}}}."""
    ...
    def eval(self) -> Dict:
        ...
        return {self.field: {self.__type__: {'$lte': self.value}}}
