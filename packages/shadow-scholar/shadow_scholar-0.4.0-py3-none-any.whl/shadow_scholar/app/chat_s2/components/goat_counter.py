...
def add_goat_counter_tracker():
    ...
    skiff_stats_script = (
        ...
        'data-spa="true" async></script>'
    )

    if get_environment() == "prod":
        # This is an extreme workaround to be able to inject a script tag i
        # nto the streamlit template.
        # Streamlit goes through well-meaning lengths to prevent this for
        # security reasons.
        # So we are essentially altering the base streamlit index.html file.
        # inspired by:
        # github.com/streamlit/streamlit/issues/969#issuecomment-1030832993
        ...
        # This is mainly a tool for aiding development in case the prod ENV is
