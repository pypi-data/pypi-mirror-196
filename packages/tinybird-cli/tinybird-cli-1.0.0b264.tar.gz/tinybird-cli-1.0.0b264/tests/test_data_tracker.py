...
class TestDataTracker(BaseTest):
    ...
    def test_data_tracker_updates_workspace_info(self):
        ...
        self.assertEqual(content['data'], [{'id': '1234', 'name': '1234_name', 'database': '1234_database', 'database_server': '1234_database_server', 'plan': 'dev', 'deleted': 0, 'created_at': created_at.strftime('%Y-%m-%d %H:%M:%S')}])
...
class TestUsageMetricsTracker(BaseTest):
    ...
    async def test_track_usage_metrics_storage_filters_temporary_datasources(self):
        ...
        from tinybird.ch import ch_create_table_as_table_sync
