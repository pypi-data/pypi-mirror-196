...
from orangecontrib.halfsrw.widgets.gui.ow_halfsrw_optical_element import OWHALFSRWOpticalElement
from orangecontrib.halfsrw.util.halfsrw_util import ShowErrorProfileDialog
from orangecontrib.halfsrw.util.halfsrw_objects import HALFSRWData, HALFSRWPreProcessorData, HALFSRWErrorProfileData

class OWHALFSRWGrating(OWHALFSRWOpticalElement):
    ...
    inputs = [("HALFSRWData", HALFSRWData, "set_input"),
              ...
              ("PreProcessor Data", HALFSRWPreProcessorData, "setPreProcessorData"),
    ...
    def set_additional_parameters(self, beamline_element, propagation_parameters, beamline):
        ...
        super(OWHALFSRWGrating, self).set_additional_parameters(beamline_element, propagation_parameters, beamline)
        ...
        if data is not None:
            try:
                if not data.error_profile_data is None:
                    if data.error_profile_data.error_profile_data_file != HALFSRWErrorProfileData.NONE:
