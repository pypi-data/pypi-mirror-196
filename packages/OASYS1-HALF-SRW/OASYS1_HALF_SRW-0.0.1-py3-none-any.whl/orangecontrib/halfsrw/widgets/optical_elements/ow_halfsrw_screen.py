...
from orangecontrib.halfsrw.widgets.gui.ow_halfsrw_optical_element import OWHALFSRWOpticalElement, HALFSRWWavefrontViewer

class OWHALFSRWScreen(OWHALFSRWOpticalElement):

    name = "Screen"
    description = "HALFSRW: Screen"
