...
class OWHALFSRWGaussianSource(HALFSRWWavefrontViewer, WidgetDecorator):
    ...
    description = "HALFSRW Source: Gaussian Source"
    ...
    def runHALFSRWSource(self):
        ...
        try:
            ...
            halfsrw_source = self.get_halfsrw_source()
            ...
            wavefront = self.calculate_wavefront_propagation(halfsrw_source)
            ...
            self.send("HALFSRWData", HALFSRWData(halfsrw_beamline=beamline, halfsrw_wavefront=wavefront))
    ...
    def run_calculation_intensity(self, halfsrw_wavefront, tickets, progress_bar_value=30):

        e, h, v, i = halfsrw_wavefront.get_intensity(multi_electron=False)

        HALFSRWWavefrontViewer.add_2D_wavefront_plot(e, h, v, i, tickets)

        self.progressBarSet(progress_bar_value)

        e, h, v, i = halfsrw_wavefront.get_phase()
