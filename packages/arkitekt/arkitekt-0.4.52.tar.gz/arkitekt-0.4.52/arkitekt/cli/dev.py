...
async def dev_module(identifier, version, entrypoint,  builder: str = "arkitekt.builders.easy", deep: bool = False):
    ...
    if deep:
        try:
            ...
            raise ImportError("You must install the reloader package to use the --with-dependencies flag")
    ...
    async for changes in awatch(".", watch_filter=EntrypointFilter(entrypoint), debounce=2000, step=500):
