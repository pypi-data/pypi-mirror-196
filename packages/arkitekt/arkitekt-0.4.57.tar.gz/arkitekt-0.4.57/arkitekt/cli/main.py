...
welcome = """
Welcome to Arkitekt. Arkitekt is a bioimage analysis framework for building beautiful 
and fast (serverless) APIs around your python code. It is buid on top of composable 
packages like mikro, fluss and rekuest, which allow you to build simple apps with ease.
"""
...
def prompt_scopes():
    ...
    scope_text = "\n\n[white]Every arkitekt app is assigned specific permissions to access data and interact with the" \
                  ...
                  "that are already in place. You can find a list of all available scopes "\
...
def init(identifier, version, author, entrypoint, builder, scopes, template):
    ...
    manifest = Manifest(
            author=author or click.prompt(" Your name:", default=getattr(oldmanifest, "author", "john doe")),
