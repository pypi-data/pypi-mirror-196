...
class TestGaussian(unittest.TestCase):
    ...
    def test_totalPower(self):
        ...
        self.assertAlmostEqual(self.beam.totalPower, 5309116)

    def test_power_eta(self):
        """`test_power_eta` tests the clip-level power."""

        self.assertAlmostEqual(self.beam.power_eta, 1058333.0)
    ...
    def test_averagePowerDensity_eta(self):
        ...
        self.assertAlmostEqual(
            self.beam.averagePowerDensity_eta, 898.4151103565365)
    ...
    def test_topHatFactor(self):
        ...
        self.assertAlmostEqual(self.beam.topHatFactor, 0.5007914662278968)
