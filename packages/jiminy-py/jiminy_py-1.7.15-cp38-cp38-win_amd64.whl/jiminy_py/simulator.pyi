...
from .viewer import Viewer as Viewer, extract_replay_data_from_log as extract_replay_data_from_log, get_default_backend as get_default_backend, interactive_mode as interactive_mode, play_trajectories as play_trajectories
...
class Simulator:
    ...
    @classmethod
    def build(cls, urdf_path: str, hardware_path: Optional[str] = ..., mesh_path: Optional[str] = ..., has_freeflyer: bool = ..., config_path: Optional[str] = ..., avoid_instable_collisions: bool = ..., debug: bool = ..., **kwargs: Any) -> Simulator: ...
    ...
    def render(self, return_rgb_array: bool = ..., width: Optional[int] = ..., height: Optional[int] = ..., camera_xyzrpy: Optional[Tuple[Union[Tuple[float, float, float], np.ndarray], Union[Tuple[float, float, float], np.ndarray]]] = ..., update_ground_profile: Optional[bool] = ..., **kwargs: Any) -> Optional[np.ndarray]: ...
    ...
    def close(self) -> None: ...
    def plot(self, enable_flexiblity_data: bool = ..., block: Optional[bool] = ..., **kwargs: Any) -> None: ...
