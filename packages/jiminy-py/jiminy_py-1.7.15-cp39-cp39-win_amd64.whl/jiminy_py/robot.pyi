...
class BaseJiminyRobot(jiminy.Robot):
    ...
    def __init__(self) -> None: ...
    def initialize(self, urdf_path: str, hardware_path: Optional[str] = ..., mesh_path: Optional[str] = ..., has_freeflyer: bool = ..., avoid_instable_collisions: bool = ..., load_visual_meshes: bool = ..., verbose: bool = ...) -> None: ...
