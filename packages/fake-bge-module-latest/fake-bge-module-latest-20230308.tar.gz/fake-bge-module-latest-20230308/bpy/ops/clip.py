...
def add_marker(location: 'mathutils.Vector' = (0.0, 0.0)):
...
def bundles_to_mesh():
    ''' Create vertex cloud using coordinates of reconstructed tracks :file: startup/bl_operators/clip.py\:281 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py$281> _
...
def constraint_to_fcurve():
    ''' Create F-Curves for object which will copy object's movement caused by this constraint :file: startup/bl_operators/clip.py\:519 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py$519> _
...
def delete_proxy():
    ''' Delete movie clip proxy files from the hard drive :file: startup/bl_operators/clip.py\:348 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py$348> _
...
def dopesheet_select_channel(location: 'mathutils.Vector' = (0.0, 0.0),
                             extend: bool = False):
...
def graph_select(location: 'mathutils.Vector' = (0.0, 0.0),
                 extend: bool = False):
    ''' Select graph curves
...
def set_active_clip():
    ''' Undocumented, consider contributing <https://developer.blender.org/> __. :file: startup/bl_operators/clip.py\:210 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py$210> _
...
def set_viewport_background():
    ''' Set current movie clip as a camera background in 3D Viewport (works only when a 3D Viewport is visible) :file: startup/bl_operators/clip.py\:409 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py$409> _
...
def setup_tracking_scene():
    ''' Prepare scene for compositing 3D objects into this footage :file: startup/bl_operators/clip.py\:971 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py$971> _
...
def slide_marker(offset: 'mathutils.Vector' = (0.0, 0.0)):
    ''' Slide marker areas
...
def track_settings_as_default():
    ''' Copy tracking settings from active track to default settings :file: startup/bl_operators/clip.py\:1000 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py$1000> _
...
def track_settings_to_track():
    ''' Copy tracking settings from active track to selected tracks :file: startup/bl_operators/clip.py\:1049 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py$1049> _
...
def track_to_empty():
    ''' Create an Empty object which will be copying movement of active track :file: startup/bl_operators/clip.py\:257 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py$257> _
...
def view_pan(offset: 'mathutils.Vector' = (0.0, 0.0)):
    ''' Pan the view
...
def view_zoom_in(location: 'mathutils.Vector' = (0.0, 0.0)):
    ''' Zoom in the view
...
def view_zoom_out(location: 'mathutils.Vector' = (0.0, 0.0)):
    ''' Zoom out the view
