...
def anim_transforms_to_deltas():
    ''' Convert object animation for normal transforms to delta transforms :file: startup/bl_operators/object.py\:773 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py$773> _
...
def geometry_nodes_move_to_nodes():
    ''' Move inputs and outputs from in the modifier to a new node group :file: startup/bl_operators/geometry_nodes.py\:110 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py$110> _
...
def hide_render_clear_all():
    ''' Reveal all render objects by setting the hide render flag :file: startup/bl_operators/object.py\:680 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py$680> _
...
def instance_offset_from_cursor():
    ''' Set offset used for collection instances based on cursor position :file: startup/bl_operators/object.py\:858 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py$858> _
...
def instance_offset_from_object():
    ''' Set offset used for collection instances based on the active object position :file: startup/bl_operators/object.py\:1046 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py$1046> _
...
def instance_offset_to_cursor():
    ''' Set cursor position to the offset used for collection instances :file: startup/bl_operators/object.py\:1029 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py$1029> _
...
def isolate_type_render():
    ''' Hide unselected render objects of same type as active by setting the hide render flag :file: startup/bl_operators/object.py\:660 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py$660> _
...
def join_uvs():
    ''' Transfer UV Maps from active to selected objects (needs matching geometry) :file: startup/bl_operators/object.py\:567 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py$567> _
...
def lod_by_name():
    ''' Add levels of detail to this object based on object names :file: startup/bl_operators/object.py\:1181 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py$1181> _
...
def lod_clear_all():
    ''' Remove all levels of detail from this object :file: startup/bl_operators/object.py\:1231 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py$1231> _
...
def make_dupli_face():
    ''' Convert objects into instanced faces :file: startup/bl_operators/object.py\:648 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object.py$648> _
