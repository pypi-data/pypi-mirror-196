...
def add_target():
    ''' Add a target to the constraint :file: startup/bl_operators/constraint.py\:23 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/constraint.py$23> _
...
def normalize_target_weights():
    ''' Normalize weights of all target bones :file: startup/bl_operators/constraint.py\:58 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/constraint.py$58> _
