...
def addon_refresh():
    ''' Scan add-on directories for new modules :file: startup/bl_operators/userpref.py\:570 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/userpref.py$570> _
...
def copy_prev():
    ''' Copy settings from previous version :file: startup/bl_operators/userpref.py\:141 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/userpref.py$141> _
...
def keyconfig_remove():
    ''' Remove key config :file: startup/bl_operators/userpref.py\:414 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/userpref.py$414> _
...
def keyconfig_test():
    ''' Test key configuration for conflicts :file: startup/bl_operators/userpref.py\:163 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/userpref.py$163> _
...
def keyitem_add():
    ''' Add key map item :file: startup/bl_operators/userpref.py\:362 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/userpref.py$362> _
...
def studiolight_show():
    ''' Show light preferences :file: startup/bl_operators/userpref.py\:1136 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/userpref.py$1136> _
