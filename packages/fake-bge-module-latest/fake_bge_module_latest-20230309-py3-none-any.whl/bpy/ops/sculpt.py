...
def cloth_filter(
        start_mouse: typing.List[int] = (0, 0),
        area_normal_radius: float = 0.25,
        strength: float = 1.0,
        iteration_count: int = 1,
        event_history: typing.
    ...
    :type start_mouse: typing.List[int]
    ...
    :type event_history: typing.Union[typing.Dict[str, 'bpy.types.OperatorStrokeElement'], typing.List['bpy.types.OperatorStrokeElement'], 'bpy_prop_collection']
