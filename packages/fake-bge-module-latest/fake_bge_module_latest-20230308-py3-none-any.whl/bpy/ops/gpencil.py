...
def layer_add(layer: int = 0, new_layer_name: str = ""):
...
def tint_flip():
    ''' Switch tint colors :file: startup/bl_ui/properties_grease_pencil_common.py\:869 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_ui/properties_grease_pencil_common.py$869> _
