...
def crossfade_sounds():
    ''' Do cross-fading volume animation of two selected sound strips :file: startup/bl_operators/sequencer.py\:26 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/sequencer.py$26> _
...
def deinterlace_selected_movies():
    ''' Deinterlace all selected movie sources :file: startup/bl_operators/sequencer.py\:114 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/sequencer.py$114> _
...
def fades_clear():
    ''' Removes fade animation from selected sequences :file: startup/bl_operators/sequencer.py\:133 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/sequencer.py$133> _
...
def retiming_handle_add(timeline_frame: int = 0):
    ''' Add retiming Handle
...
def retiming_handle_move(handle_index: int = 0):
    ''' Move retiming handle

    :param handle_index: Handle Index, Index of handle to be moved
    :type handle_index: int
    '''

    pass


def retiming_handle_remove(handle_index: int = 0):
