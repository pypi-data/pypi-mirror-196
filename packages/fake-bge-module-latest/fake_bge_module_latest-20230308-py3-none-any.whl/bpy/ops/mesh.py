...
def attribute_set(value_float: float = 0.0,
                  value_float_vector_2d: typing.List[float] = (0.0, 0.0),
                  value_float_vector_3d: typing.List[float] = (0.0, 0.0, 0.0),
                  value_int: int = 0,
                  value_color: typing.List[float] = (1.0, 1.0, 1.0, 1.0),
    ...
    :type value_float_vector_2d: typing.List[float]
    :param value_float_vector_3d: Value
    :type value_float_vector_3d: typing.List[float]
    :param value_int: Value
    :type value_int: int
    :param value_color: Value
    :type value_color: typing.List[float]
...
def select_next_item():
    ''' Select the next element (using selection order) :file: startup/bl_operators/mesh.py\:195 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/mesh.py$195> _
...
def select_prev_item():
    ''' Select the previous element (using selection order) :file: startup/bl_operators/mesh.py\:220 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/mesh.py$220> _
