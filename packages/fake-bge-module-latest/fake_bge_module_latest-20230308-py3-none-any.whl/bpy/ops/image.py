...
def project_apply():
    ''' Project edited image back onto the object :file: startup/bl_operators/image.py\:179 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/image.py$179> _
...
def project_edit():
    ''' Edit a snapshot of the 3D Viewport in an external image editor :file: startup/bl_operators/image.py\:109 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/image.py$109> _
