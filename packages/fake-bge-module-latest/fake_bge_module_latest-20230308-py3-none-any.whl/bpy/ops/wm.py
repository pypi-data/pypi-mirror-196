...
def blend_strings_utf8_validate():
    ''' Check and fix all strings in current .blend file to be valid UTF-8 Unicode (needed for some old, 2.4x area files) :file: startup/bl_operators/file.py\:288 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/file.py$288> _
...
def blenderplayer_start():
    ''' Launch the blender-player with the current blend-file :file: startup/bl_operators/wm.py\:2125 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py$2125> _
...
def operator_cheat_sheet():
    ''' List all the operators in a text-block, useful for scripting :file: startup/bl_operators/wm.py\:2175 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py$2175> _
...
def toolbar():
    ''' Undocumented, consider contributing <https://developer.blender.org/> __. :file: startup/bl_operators/wm.py\:2361 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py$2361> _
...
def toolbar_fallback_pie():
    ''' Undocumented, consider contributing <https://developer.blender.org/> __. :file: startup/bl_operators/wm.py\:2385 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py$2385> _
...
def toolbar_prompt():
    ''' Leader key like functionality for accessing tools :file: startup/bl_operators/wm.py\:2485 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py$2485> _
