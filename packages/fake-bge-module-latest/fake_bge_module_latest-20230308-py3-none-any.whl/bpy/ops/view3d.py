...
def edit_mesh_extrude_individual_move():
    ''' Extrude each individual face separately along local normals :file: startup/bl_operators/view3d.py\:21 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py$21> _
...
def edit_mesh_extrude_manifold_normal():
    ''' Extrude manifold region along normals :file: startup/bl_operators/view3d.py\:154 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py$154> _
...
def edit_mesh_extrude_move_shrink_fatten():
    ''' Extrude region together along local normals :file: startup/bl_operators/view3d.py\:137 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py$137> _
