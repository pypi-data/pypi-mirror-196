...
def startup_stuff():
    ...
    if CT:
        urlretrieve(CT, "resources/extras/puii.jpg")
    ...
    if TZ and timezone:
        try:
            ...
            LOGS.critical(
                "Incorrect Timezone ,\nCheck Available Timezone From Here https://telegra.ph/Puii-03-06\nSo Time is Default UTC"
            )
            os.environ["TZ"] = "UTC"
            time.tzset()
...
async def autobot():
    ...
    if isdone.startswith("Sorry,"):
        ...
        await puii_bot.send_message(bf, username)
        await asyncio.sleep(1)
        nowdone = (await puii_bot.get_messages(bf, limit=1))[0].text
...
async def customize():
    ...
    try:
        ...
        file = random.choice(
            [
                "https://graph.org/file/c8cb10a099c3afc2574ae.jpg",
                "https://graph.org/file/b6879a571edc7b59ab94b.jpg",
...
• Here, are the Some Basic stuff from, where you can Know, about its Usage."""
        PHOTO = "https://graph.org/file/c8cb10a099c3afc2574ae.jpg"
    ...
    try:
        ...
        await puii_bot(JoinChannelRequest("@AellyXD"))
    except BotMethodInvalidError:
        pass
    except ChannelsTooMuchError:
        LOGS.info("Join @AellyXD to know about new Updates...")
    except ChannelPrivateError:
        LOGS.critical(
            "You are Banned from @AellyXD for some reason. Contact any dev if you think there is some mistake..."
        )
        import sys
