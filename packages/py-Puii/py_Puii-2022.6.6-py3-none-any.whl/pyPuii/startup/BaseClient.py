...
class PuiiClient(TelegramClient):
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from pyPuii.functions.FastTelethon import upload_file
        from pyPuii.functions.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from pyPuii.functions.FastTelethon import download_file
        from pyPuii.functions.helper import progress
