...
async def _insta_login():
    if "insta_creds" in puii_bot._cache:
        return puii_bot._cache["insta_creds"]
    ...
    if username and password:
        ...
        try:
            ...
            puii_bot._cache.update({"insta_creds": cl})
...
async def get_insta_code(username, choice):
    ...
    async with asst.conversation(puii_bot.uid, timeout=60 * 2) as conv:
