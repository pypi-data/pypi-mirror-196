...
class BaseModel(db.Model):
    ...
    def __init__(self, data, from_seed_file=False):
        ...
        self.created_at = serialize_datetime(datetime.datetime.now(), datetime_format)
    ...
    def _get_base_details(self):
        ...
        if self.last_updated_at:
            base_details['last_updated_at'] = serialize_datetime(
                self.last_updated_at, datetime_format
            )
        else:
    ...
    @classmethod
    def return_with_summary(cls, objects, params, count):
    ...
    def update(self, data):
        ...
        self.last_updated_at = serialize_datetime(datetime.datetime.now(), datetime_format)
        if request and request.user and request.user.id_:
    ...
    def soft_delete(self):
        ...
        self.token = None
        self.deleted_at = serialize_datetime(datetime.datetime.now(), datetime_format)
