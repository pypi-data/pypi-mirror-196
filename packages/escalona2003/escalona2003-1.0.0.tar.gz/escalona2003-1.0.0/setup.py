...
short_descr = "Data and formalisms from Escalona et al. (2003)"
...
pkg_data = {'escalona2003': data_files}
...
setup_kwds = dict(
    ...
    url='https://gitlab.com/b326/escalona2003',
    license='cc_by_nc',
    zip_safe=False,
