...
**escalona2003** could always use more documentation, whether as
part of the official **escalona2003** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `escalona2003` for local
development.

1. Fork the `escalona2003` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/escalona2003.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd escalona2003
    (dvlpt) escalona2003$ flake8
    (dvlpt) escalona2003$ pytest
    
    (dvlpt) escalona2003$ tox
...
.. _issues: https://gitlab.com/b326/escalona2003/issues
