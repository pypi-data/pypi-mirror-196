        ...
        self.v1beta1_photo_identifiers_list_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'retention_period__is_null': 'retention_period__isNull',
                ...
                'location_map': {
                    ...
                    'retention_period__is_null': 'query',
    ...
    def v1beta1_photo_identifiers_list(
        ...
        **kwargs
        ...
        Keyword Args:
            ...
            retention_period__gte (str): Filter retentionPeriod by IsoDateTime greater than. [optional]
            retention_period__is_null (bool): Filter retentionPeriod by IsoDateTime is Null. [optional]
            retention_period__isnull (bool): [optional]
            retention_period__lte (str): Filter retentionPeriod by IsoDateTime less than. [optional]
    ...
    def v1beta1_photo_identifiers_partial_update(
        ...
        **kwargs
        ...
        """Update a photo identifier by photo identifier UUID.  # noqa: E501
         ...
         ## Update the photo identifier  This method allows a client to submit an action in the request query for a given photo identifier. The allowed action is `update`.  ### Permissions  Principals with the `CARD_ADMIN` permission will be able to affect this endpoint.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        Keyword Args:
            action (str): Action applied to the photo identifier.. [optional] if omitted the server will use the default value of "update"
