...
class PhotoIdentifiersIncludingPhotosApi(object):
    ...
    def v1beta1_photo_identifiers_destroy(
        ...
        **kwargs
        ...
        """Remove a photo identifier and associated photos by photo identifier UUID.  # noqa: E501
         ...
         ## Remove photo identifier  This method allows a client to remove a photo identifier and in the process purge all associated identifiers and photos.  ### Permissions  Principals with the `PHOTO_ADMIN` permission are able to affect this endpoint.    # noqa: E501
