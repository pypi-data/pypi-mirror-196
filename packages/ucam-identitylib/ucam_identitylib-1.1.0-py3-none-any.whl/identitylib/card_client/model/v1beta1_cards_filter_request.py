...
class V1beta1CardsFilterRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'expires_at__gte': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'expires_at__lte': (datetime,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'expires_at__gte': 'expires_at__gte',  # noqa: E501
        'expires_at__lte': 'expires_at__lte',  # noqa: E501
    ...
    def _from_openapi_data(cls, identifiers, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            expires_at__gte (bool, date, datetime, dict, float, int, list, str, none_type): Filter expiresAt by IsoDateTime greater than. [optional]  # noqa: E501
            expires_at__lte (datetime): Filter expiresAt by IsoDateTime less than. [optional]  # noqa: E501
            institution (str): Institution to filter by in the format {value}@{scheme}. The scheme must be the Lookup institution scheme: `insts.lookup.cam.ac.uk`, if the @{scheme} is omitted this value is assumed.. [optional]  # noqa: E501
