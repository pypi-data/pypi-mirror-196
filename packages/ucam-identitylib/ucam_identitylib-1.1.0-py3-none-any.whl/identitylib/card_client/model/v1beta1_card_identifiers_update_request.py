...
class V1beta1CardIdentifiersUpdateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """V1beta1CardIdentifiersUpdateRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            action (str): The action to apply to this card identifier.. [optional] if omitted the server will use the default value of "update"  # noqa: E501
        """
