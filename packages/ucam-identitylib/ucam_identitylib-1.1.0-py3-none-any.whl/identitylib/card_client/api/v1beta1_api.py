...
class V1beta1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1beta1_card_identifiers_list_endpoint = _Endpoint(
            settings={
                'response_type': (V1beta1CardIdentifiersList200Response,),
                'auth': [
                    'API Service OAuth2 Client Credentials',
                    'API Service OAuth2 Access Code'
                ],
            ...
            params_map={
                'all': [
                    'retention_period__lte',
                    'retention_period__gte',
                    'retention_period__isnull',
                    'identifier',
                    'scheme',
                    'cursor',
                    'page_size',
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'retention_period__isnull': 'retention_period__isnull',
                ...
                'location_map': {
                    'retention_period__lte': 'query',
                    'retention_period__gte': 'query',
                    'retention_period__isnull': 'query',
                    'identifier': 'query',
                    'scheme': 'query',
                    'cursor': 'query',
                    'page_size': 'query',
        ...
        self.v1beta1_card_identifiers_update_endpoint = _Endpoint(
            settings={
                'response_type': (V1beta1CardIdentifiersUpdate200Response,),
                'auth': [
                    'API Service OAuth2 Client Credentials',
                    'API Service OAuth2 Access Code'
                ],
            ...
            root_map={
                ...
                'openapi_types': {
                    'id':
                        (str,),
                    'data':
                        (V1beta1CardIdentifiersUpdateRequest,),
                },
                'attribute_map': {
                    'id': 'id',
                },
        ...
        self.v1beta1_card_notes_list_endpoint = _Endpoint(
            settings={
                'response_type': (V1beta1CardNotesList200Response,),
                'auth': [
                    'API Service OAuth2 Client Credentials',
                    'API Service OAuth2 Access Code'
                ],
        ...
        self.v1beta1_cards_filter_endpoint = _Endpoint(
            settings={
                'response_type': (V1beta1CardsFilter200Response,),
                'auth': [
                    'API Service OAuth2 Client Credentials',
                    'API Service OAuth2 Access Code'
                ],
        ...
        self.v1beta1_college_institution_ids_list_endpoint = _Endpoint(
            settings={
                'response_type': (V1beta1CollegeInstitutionIdsList200Response,),
                'auth': [
                    'API Service OAuth2 Client Credentials',
                    'API Service OAuth2 Access Code'
                ],
    ...
    def v1beta1_card_identifiers_delete(
        ...
        **kwargs
        ...
        """Remove a card identifier by UUID.  # noqa: E501
         ...
         ## Remove card identifier  This method allows a client to remove a card identifier and in the process purge all associated identifiers, cards and card requests.  This method only operates on the primary identifiers: - `person.v1.legacy-card.university.identifiers.cam.ac.uk` the CRSid identifier of the cardholder - `person.v1.legacy-card.university.identifiers.cam.ac.uk` the legacy identifier of the cardholder  ### Permissions  Principals with the `CARD_ADMIN` permission are able to affect this endpoint.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v1beta1_card_identifiers_delete(id, data, async_req=True)
        >>> result = thread.get()
    ...
    def v1beta1_card_identifiers_list(
        ...
        **kwargs
        ...
        Keyword Args:
            retention_period__lte (datetime): Filter retentionPeriod by IsoDateTime less than. [optional]
            retention_period__gte (datetime): Filter retentionPeriod by IsoDateTime greater than. [optional]
            retention_period__isnull (bool): Filter retentionPeriod by IsoDateTime is Null. [optional]
        ...
        Returns:
            V1beta1CardIdentifiersList200Response
                If the method is called asynchronously, returns the request
                thread.
        """
        kwargs['async_req'] = kwargs.get(
    ...
    def v1beta1_card_identifiers_update(
        ...
        **kwargs
        ...
        """Update the card identifier  # noqa: E501
         ...
         ## Update the card identifier  This method allows a client to submit an action in the request body for a given card identifier. The allowed action is `update`.  ### Permissions  Principals with the `CARD_ADMIN` permission will be able to affect this endpoint.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        Args:
            id (str): A UUID string identifying this card identifier.
            data (V1beta1CardIdentifiersUpdateRequest):
        ...
        Returns:
            V1beta1CardIdentifiersUpdate200Response
                If the method is called asynchronously, returns the request
                thread.
        """
        kwargs['async_req'] = kwargs.get(
    ...
    def v1beta1_card_notes_list(
        ...
        **kwargs
        ...
        Returns:
            V1beta1CardNotesList200Response
                If the method is called asynchronously, returns the request
                thread.
        """
        kwargs['async_req'] = kwargs.get(
    ...
    def v1beta1_college_institution_ids_list(
        ...
        **kwargs
        ...
        Returns:
            V1beta1CollegeInstitutionIdsList200Response
                If the method is called asynchronously, returns the request
                thread.
        """
        kwargs['async_req'] = kwargs.get(
