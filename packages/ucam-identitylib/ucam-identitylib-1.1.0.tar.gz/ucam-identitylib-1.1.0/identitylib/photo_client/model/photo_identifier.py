...
class PhotoIdentifier(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'value': (str,),  # noqa: E501
            'retention_period': (datetime, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, id, photos, related_identifiers, scheme, value, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            retention_period (datetime, none_type): If non-NULL, the minimum period the record should be retained. [optional]  # noqa: E501
        """
