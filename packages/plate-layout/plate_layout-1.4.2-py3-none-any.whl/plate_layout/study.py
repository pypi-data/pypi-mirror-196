...
class Study:
    ...
    def load_specimen_records(self, records_file : str):
        ...
        logger.info(f"Loading records file: {records_file}")
    ...
    def add_specimens_to_plate(self, study_plate: object,
        ...
        logger.info(f"Adding samples to plate {study_plate.plate_id}")
    ...
    def to_layout_lists(self, metadata_keys: list = None,
        ...
        for plate in self:
            ...
            plate.to_file(metadata_keys=metadata_keys,
                          file_path=file_path,
                          file_format=file_format,
                          )

    def to_layout_figures(self,
                          annotation_metadata_key: str = None,
                          color_metadata_key: str = None,
                          file_format: str = "pdf",
                          folder_path: str = None,
    ...
    def randomize_order(self, case_control : bool = None, reproducible=True):
        ...
        if case_control:
            ...
            specimen_records_df_copy = \
                specimen_records_df_copy.set_index([column_with_group_index,
        ...
        if reproducible:
            logger.info("Using a fixed seed to random number generator for \
                reproducibility; running this method will always give the \
                    same result.")
        ...
        specimen_records_df_copy = specimen_records_df_copy\
            .rename(columns={"index": "index_before_permutation"})
