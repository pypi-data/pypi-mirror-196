...
class ZIMFLI(Instrument):
    ...
    def __init__(self, name: str, device_ID: str, **kwargs) -> None:
        ...
        for demod in range(1, 3):
            ...
            dmtrigs = {'Continuous': 0,
                       ...
                       'Trigger in 1 Fall': 2,
                       'Trigger in 1 Both': 3,
                       'Trigger in 1 High': 32,
                       'Trigger in 1 Low': 16,
                       'Trigger in 2 Rise': 4,
                       'Trigger in 2 Fall': 8,
                       'Trigger in 2 Both': 12,
                       'Trigger in 2 High': 128,
                       'Trigger in 2 Low': 64,
                       'Trigger in 1|2 Rise': 5,
                       'Trigger in 1|2 Fall': 10,
                       'Trigger in 1|2 Both': 15,
                       'Trigger in 1|2 High': 160,
                       'Trigger in 1|2 Low': 80}
        ...
        ########################################
        # SIGNAL OUTPUTS
        outputamps = {1: 'amplitudes/1'}
        outputampenable = {1: 'enables/1'}

        for sigout in range(1,2):
    ...
    def snapshot_base(self, update: bool = True,
        ...
        return super(ZIMFLI, self).snapshot_base(update=update,
    ...
    # Utility functions
    def auto_phase(self):
        self.daq.setInt('/{}/demods/0/phaseadjust'.format(self.device), 1)
