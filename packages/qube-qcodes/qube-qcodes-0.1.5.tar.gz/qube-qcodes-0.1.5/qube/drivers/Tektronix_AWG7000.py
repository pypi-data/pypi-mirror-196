...
class Tektronix_AWG7000(VisaInstrument):
    """
    This is the QCoDeS driver for the Tektronix AWG7000 series
    Note: it is an adaptation of qcodes.intrument_drivers.tektronix.AWG5014
    ...
    def __init__(
            self,
            name: str,
            address: str,  # For instance 'TCPIP0::192.168.0.14::inst0::INSTR'
            timeout: int = 180,
            num_channels: int = 2,
            **kwargs: Any):
        """
        Initializes the AWG7000 series.
        Args:
        ...
        for i in range(1, self.num_channels + 1):
            ...
            self.add_parameter(f'ch{i}_DC_out',
                               ...
                               get_parser=float)
            self.add_parameter(f'ch{i}_skew',
                               label=f'Channel {i} skew',
                               unit='ps',
                               get_cmd=skew_cmd + '?',
                               set_cmd=skew_cmd + ' {}ps',
...
Tektronix_AWG7122C = Tektronix_AWG7000
