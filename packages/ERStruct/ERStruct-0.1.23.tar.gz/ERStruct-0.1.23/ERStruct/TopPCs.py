...
def download_sample():
    data1 = pkg_resources.resource_string("ERStruct", 'data/chr21.npy')
    data2 = pkg_resources.resource_string("ERStruct", 'data/chr22.npy')
    np.save('char21.npy', data1)
    np.save('char22.npy', data2)
    print('Sample data \"char21.npy\" and \"char22.npy\" are saved in the current directory')
