...
class SCIMConfig(object):
    ...
    def update_isam_user(self, ldap_connection=None, isam_domain=None, update_native_users=None):
        '''
        Update SCIM user mappings for basic and full Verify Access users.

        Args:
            ldap_connection (:obj:`str`): The name of the ldap server connection to the Verify Access user registry.
