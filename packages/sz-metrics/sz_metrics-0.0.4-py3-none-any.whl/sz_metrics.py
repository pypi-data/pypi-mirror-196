...
class SZ_Calibration_Metric:
    ...
    def get_performance_metrics(y_true, y_pred, loss=float('nan')):
        

        true_negatives,false_positives,false_negatives , true_positives = confusion_matrix(y_true, y_pred, labels=[0, 1]).ravel()
