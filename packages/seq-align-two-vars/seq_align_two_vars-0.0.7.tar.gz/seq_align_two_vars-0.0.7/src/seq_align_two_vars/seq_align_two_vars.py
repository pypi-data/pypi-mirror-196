...
# length > 3
def make_sample(length, category, size, var = 2, prob = None, distribution = np.random.uniform, var_len=False):
    """
    ## Description:
...
#logistic network
def random_walk(G, walk_len, count, var=2, distribution=np.random.uniform):
    """
    ## Description:
