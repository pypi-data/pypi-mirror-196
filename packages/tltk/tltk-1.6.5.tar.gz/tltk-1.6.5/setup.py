...
#    packages=find_packages(exclude=['contrib', 'docs', 'tests']),
  ...
  #  },
    ...
    package_data={
        'tltk': ['sylrule.lts', 'thaisyl.dict', 'PhSTrigram.sts', 'sylseg.3g', 'sylform_var.pick', 'thdict', 'BEST.dict', 'pos_tagger.pick', 'sent_segment.pklz', 'ner_tagger.pick','word.pklz','th_malt.mco'],
    },
