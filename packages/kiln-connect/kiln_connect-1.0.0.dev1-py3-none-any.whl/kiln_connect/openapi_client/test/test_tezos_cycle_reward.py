...
from kiln_connect.openapi_client.models.tezos_cycle_reward import TezosCycleReward  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestTezosCycleReward(unittest.TestCase):
    """TezosCycleReward unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test TezosCycleReward
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TezosCycleReward`
        """
        model = kiln_connect.openapi_client.models.tezos_cycle_reward.TezosCycleReward()  # noqa: E501
        if include_optional :
