...
class EthereumPostKeysCliResponseInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EthereumPostKeysCliResponseInner:
        """Create an instance of EthereumPostKeysCliResponseInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EthereumPostKeysCliResponseInner:
        """Create an instance of EthereumPostKeysCliResponseInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EthereumPostKeysCliResponseInner.parse_obj(obj)

        _obj = EthereumPostKeysCliResponseInner.parse_obj({
