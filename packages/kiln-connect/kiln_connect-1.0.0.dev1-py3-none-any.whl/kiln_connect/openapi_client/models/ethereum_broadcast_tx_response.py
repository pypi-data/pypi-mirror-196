...
class EthereumBroadcastTxResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EthereumBroadcastTxResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EthereumBroadcastTxResponse:
        """Create an instance of EthereumBroadcastTxResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EthereumBroadcastTxResponse.parse_obj(obj)

        _obj = EthereumBroadcastTxResponse.parse_obj({
