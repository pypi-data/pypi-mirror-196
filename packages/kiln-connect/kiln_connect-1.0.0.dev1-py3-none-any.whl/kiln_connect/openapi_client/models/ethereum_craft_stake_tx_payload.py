...
class EthereumCraftStakeTxPayload(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EthereumCraftStakeTxPayload:
        """Create an instance of EthereumCraftStakeTxPayload from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EthereumCraftStakeTxPayload:
        """Create an instance of EthereumCraftStakeTxPayload from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EthereumCraftStakeTxPayload.parse_obj(obj)

        _obj = EthereumCraftStakeTxPayload.parse_obj({
