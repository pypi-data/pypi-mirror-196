...
class EthereumUnsignedStakeTx(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EthereumUnsignedStakeTx:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EthereumUnsignedStakeTx:
        """Create an instance of EthereumUnsignedStakeTx from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EthereumUnsignedStakeTx.parse_obj(obj)

        _obj = EthereumUnsignedStakeTx.parse_obj({
