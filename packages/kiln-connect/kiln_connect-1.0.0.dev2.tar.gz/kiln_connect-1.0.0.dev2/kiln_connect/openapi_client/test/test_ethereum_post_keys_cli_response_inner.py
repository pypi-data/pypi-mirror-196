...
from kiln_connect.openapi_client.models.ethereum_post_keys_cli_response_inner import EthereumPostKeysCliResponseInner  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestEthereumPostKeysCliResponseInner(unittest.TestCase):
    """EthereumPostKeysCliResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EthereumPostKeysCliResponseInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EthereumPostKeysCliResponseInner`
        """
        model = kiln_connect.openapi_client.models.ethereum_post_keys_cli_response_inner.EthereumPostKeysCliResponseInner()  # noqa: E501
        if include_optional :
            return EthereumPostKeysCliResponseInner(
                format = 'cli_deposit', 
    ...
    def testEthereumPostKeysCliResponseInner(self):
        """Test EthereumPostKeysCliResponseInner"""
