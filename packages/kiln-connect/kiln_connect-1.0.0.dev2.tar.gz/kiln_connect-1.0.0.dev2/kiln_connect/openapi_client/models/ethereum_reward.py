...
class EthereumReward(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EthereumReward:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EthereumReward:
        """Create an instance of EthereumReward from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EthereumReward.parse_obj(obj)

        _obj = EthereumReward.parse_obj({
