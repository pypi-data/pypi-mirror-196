...
class EthereumSignedTx(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EthereumSignedTx:
        """Create an instance of EthereumSignedTx from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EthereumSignedTx:
        """Create an instance of EthereumSignedTx from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EthereumSignedTx.parse_obj(obj)

        _obj = EthereumSignedTx.parse_obj({
