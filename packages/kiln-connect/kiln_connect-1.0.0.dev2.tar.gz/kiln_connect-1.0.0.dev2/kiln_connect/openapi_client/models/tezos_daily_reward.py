...
class TezosDailyReward(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TezosDailyReward:
        """Create an instance of TezosDailyReward from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TezosDailyReward:
        """Create an instance of TezosDailyReward from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TezosDailyReward.parse_obj(obj)

        _obj = TezosDailyReward.parse_obj({
