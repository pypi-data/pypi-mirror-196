...
class TezosCycleReward(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TezosCycleReward:
        """Create an instance of TezosCycleReward from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TezosCycleReward:
        """Create an instance of TezosCycleReward from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TezosCycleReward.parse_obj(obj)

        _obj = TezosCycleReward.parse_obj({
            "cycle": obj.get("cycle"),
