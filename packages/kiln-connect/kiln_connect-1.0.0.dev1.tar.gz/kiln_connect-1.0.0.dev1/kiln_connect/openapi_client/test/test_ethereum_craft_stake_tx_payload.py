...
from kiln_connect.openapi_client.models.ethereum_craft_stake_tx_payload import EthereumCraftStakeTxPayload  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestEthereumCraftStakeTxPayload(unittest.TestCase):
    """EthereumCraftStakeTxPayload unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EthereumCraftStakeTxPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EthereumCraftStakeTxPayload`
        """
        model = kiln_connect.openapi_client.models.ethereum_craft_stake_tx_payload.EthereumCraftStakeTxPayload()  # noqa: E501
        if include_optional :
            return EthereumCraftStakeTxPayload(
    ...
    def testEthereumCraftStakeTxPayload(self):
        """Test EthereumCraftStakeTxPayload"""
