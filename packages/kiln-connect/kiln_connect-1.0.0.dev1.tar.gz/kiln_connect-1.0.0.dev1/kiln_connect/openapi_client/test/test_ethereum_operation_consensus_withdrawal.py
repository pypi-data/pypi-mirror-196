...
from kiln_connect.openapi_client.models.ethereum_operation_consensus_withdrawal import EthereumOperationConsensusWithdrawal  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestEthereumOperationConsensusWithdrawal(unittest.TestCase):
    """EthereumOperationConsensusWithdrawal unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EthereumOperationConsensusWithdrawal
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EthereumOperationConsensusWithdrawal`
        """
        model = kiln_connect.openapi_client.models.ethereum_operation_consensus_withdrawal.EthereumOperationConsensusWithdrawal()  # noqa: E501
        if include_optional :
            return EthereumOperationConsensusWithdrawal(
    ...
    def testEthereumOperationConsensusWithdrawal(self):
        """Test EthereumOperationConsensusWithdrawal"""
