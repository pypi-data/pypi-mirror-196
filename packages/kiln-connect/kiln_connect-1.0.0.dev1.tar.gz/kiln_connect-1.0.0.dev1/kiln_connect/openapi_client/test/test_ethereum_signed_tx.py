...
from kiln_connect.openapi_client.models.ethereum_signed_tx import EthereumSignedTx  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestEthereumSignedTx(unittest.TestCase):
    """EthereumSignedTx unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EthereumSignedTx
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EthereumSignedTx`
        """
        model = kiln_connect.openapi_client.models.ethereum_signed_tx.EthereumSignedTx()  # noqa: E501
        if include_optional :
