...
from kiln_connect.openapi_client.models.ethereum_post_keys_batch_response import EthereumPostKeysBatchResponse  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestEthereumPostKeysBatchResponse(unittest.TestCase):
    """EthereumPostKeysBatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EthereumPostKeysBatchResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EthereumPostKeysBatchResponse`
        """
        model = kiln_connect.openapi_client.models.ethereum_post_keys_batch_response.EthereumPostKeysBatchResponse()  # noqa: E501
        if include_optional :
            return EthereumPostKeysBatchResponse(
    ...
    def testEthereumPostKeysBatchResponse(self):
        """Test EthereumPostKeysBatchResponse"""
