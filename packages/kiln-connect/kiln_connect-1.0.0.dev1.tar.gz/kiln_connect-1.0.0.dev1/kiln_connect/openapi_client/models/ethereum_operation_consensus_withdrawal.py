...
class EthereumOperationConsensusWithdrawal(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EthereumOperationConsensusWithdrawal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EthereumOperationConsensusWithdrawal:
        """Create an instance of EthereumOperationConsensusWithdrawal from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EthereumOperationConsensusWithdrawal.parse_obj(obj)
