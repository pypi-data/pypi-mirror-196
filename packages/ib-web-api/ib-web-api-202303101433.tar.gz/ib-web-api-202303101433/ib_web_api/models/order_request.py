...
class OrderRequest(object):
    ...
    def __init__(self, acct_id=None, conid=None, conidex=None, sec_type=None, c_oid=None, parent_id=None, order_type=None, listing_exchange=None, is_single_group=None, outside_rth=None, price=None, aux_price=None, side=None, ticker=None, tif=None, trailing_amt=None, trailing_type=None, referrer=None, quantity=None, cash_qty=None, fx_qty=None, use_adaptive=None, is_ccy_conv=None, allocation_method=None, strategy=None, strategy_parameters=None):  # noqa: E501
        ...
        self._ticker = None
        self._tif = None
        self._trailing_amt = None
        self._trailing_type = None
        self._referrer = None
        self._quantity = None
        self._cash_qty = None
        self._fx_qty = None
        ...
        if trailing_amt is not None:
            self.trailing_amt = trailing_amt
    ...
    @property
    def conidex(self):
        """Gets the conidex of this OrderRequest.  # noqa: E501

        Conid and Exchange - Can be used instead of conid when specifying the contract identifier of a security.   # noqa: E501

        :return: The conidex of this OrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def conidex(self, conidex):
        """Sets the conidex of this OrderRequest.

        Conid and Exchange - Can be used instead of conid when specifying the contract identifier of a security.   # noqa: E501

        :param conidex: The conidex of this OrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def listing_exchange(self):
        ...
        listingExchange is optional. By default we use \"SMART\" routing. Possible values are available via the endpoint: /iserver/contract/{conid}/info, see **valid_exchange** e.g: SMART,AMEX,NYSE,CBOE,ISE,CHX,ARCA,ISLAND,DRCTEDGE,BEX,BATS,EDGEA,CSFBALGO,JE FFALGO,BYX,IEX,FOXRIVER,TPLUS1,NYSENAT,PSX   # noqa: E501
    ...
    def price(self):
        ...
        optional if order is LMT, or STOP_LIMIT, this is the limit price. For STP|TRAIL this is the stop price. For MIDPRICE this is the option price cap.   # noqa: E501
    ...
    def aux_price(self):
        ...
        optional if order is STOP_LIMIT|TRAILLMT, this is the stop price. You must specify both price and auxPrice for STOP_LIMIT|TRAILLMT orders.   # noqa: E501
    ...
    @property
    def trailing_amt(self):
        """Gets the trailing_amt of this OrderRequest.  # noqa: E501

        optional if order is TRAIL, or TRAILLMT. When trailingType is amt, this is the trailing amount, when trailingType is %, it means percentage. You must specify both trailingType and trailingAmt for TRAIL and TRAILLMT order   # noqa: E501

        :return: The trailing_amt of this OrderRequest.  # noqa: E501
        :rtype: float
        """
        return self._trailing_amt

    @trailing_amt.setter
    def trailing_amt(self, trailing_amt):
        """Sets the trailing_amt of this OrderRequest.

        optional if order is TRAIL, or TRAILLMT. When trailingType is amt, this is the trailing amount, when trailingType is %, it means percentage. You must specify both trailingType and trailingAmt for TRAIL and TRAILLMT order   # noqa: E501

        :param trailing_amt: The trailing_amt of this OrderRequest.  # noqa: E501
        :type: float
        """

        self._trailing_amt = trailing_amt

    @property
    def trailing_type(self):
        """Gets the trailing_type of this OrderRequest.  # noqa: E501

        This is the trailing type for trailing amount. We only support two types here: amt or %. You must specify both trailingType and trailingAmt for TRAIL and TRAILLMT order   # noqa: E501

        :return: The trailing_type of this OrderRequest.  # noqa: E501
        :rtype: str
        """
        return self._trailing_type

    @trailing_type.setter
    def trailing_type(self, trailing_type):
        """Sets the trailing_type of this OrderRequest.

        This is the trailing type for trailing amount. We only support two types here: amt or %. You must specify both trailingType and trailingAmt for TRAIL and TRAILLMT order   # noqa: E501

        :param trailing_type: The trailing_type of this OrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def quantity(self):
        ...
        Usually integer, for some special cases such as fractional orders can specify as a float, e.g. quantity = 0.001. In some special cases quantity is not specified, such as when using 'cashQty' or 'fxQty'.   # noqa: E501
