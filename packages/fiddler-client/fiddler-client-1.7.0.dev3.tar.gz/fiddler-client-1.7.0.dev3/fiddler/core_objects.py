...
class ModelInfo:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if model_deployment_params is not None:
            self.warn_deprecated_parameter(
                param_name='model_deployment_params', 
                from_version='1.7')
    ...
    def warn_deprecated_parameter(self, param_name:str, from_version:str) -> None:
        warnings.warn(
                f'WARNING: {param_name} is deprecated in {from_version}. It will be removed from 2.0.0 version.', DeprecationWarning
            )
    ...
    def from_dataset_info(
        ...
        if categorical_target_class_details is not None:
            warnings.warn(
                'WARNING: categorical_target_class_details is deprecated in 1.7 and will be removed from 2.0.0 version. As a replacement, use target_class_order while constructing ModelInfo.', DeprecationWarning
            )
        ...
        if not isinstance(dataset_info, DatasetInfo):
            raise ValueError(f'The dataset_info parameter must be a valid DatasetInfo object')
