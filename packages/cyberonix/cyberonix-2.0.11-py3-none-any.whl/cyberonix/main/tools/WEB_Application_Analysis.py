...
def main():
    while True:
        ...
        list_attacks=["Burp Suite","Owasp ZAP","Nikto","Wapiti","Nessus","dirb","skipfish","Nuclei","Arachni","go back"]
        ...
        if option=="0":
            ...
            template.template(
                "arachni",
                "cd bin && chmod +x * && ./arachni_console",
                github.strip(),
                {"Web application testing with Arachni":"https://resources.infosecinstitute.com/topic/web-application-testing-with-arachni/","How to use Arachni scanner to check vulnerability in Kali Linux":"https://www.cyberpratibha.com/blog/arachni-web-application-scanner-in-kali-linux/"},
                method="github",
                github_install="git clone https://github.com/Arachni/arachni.git && bundle install",
                github_check="arachni",
            )
