...
setup(
    ...
    python_requires='>=3.8',
    install_requires=['pandas', 'openpyxl', 'xlsxwriter', 'xlrd', 'selenium', 'easygui', 'pyperclip', 'mysql-connector-python==8.0.28',
                      'pymysql', 'pyodbc', 'sqlalchemy==1.4.37', 'psycopg2', 'pillow', 'requests==2.28.1', 'urllib3==1.26.9', 
