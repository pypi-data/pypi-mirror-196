...
def main():
    ...
    list_categories = ['shutter','spotalarm','plug','alarm','heater']
    list_categories_french = ['volet','spotalarme','prise','alarme','chauffage']
    list_actions = ['[open,close,stop,my]','[on,off]','[on,off]','[arm,disarm,partial,arm_night,arm_away]','[comfort,comfort-1,comfort-2,eco,off]']
    list_actions_french = ['[ouvrir,fermer,stop,my]','[allumer,eteindre]','[allumer,eteindre]','[activer,desactiver,partiel,activer_nuit,activer_parti]','[confort,confort-1,confort-2,eco,eteindre]']
    ...
    def info():
        ...
        print( " On the next version of Python and Linux you will need to install tahoma with pipx (using virtual env) :" )
        print( "                           sudo apt install pipx" )
        print( "                            pipx install tahoma" )
        print( "                             To update tahoma : ")
        print( "                            pipx upgrade tahoma" )
        print( "" )
        ...
        print( "" )
        print( " You can also run many commands during the same process without restarting tahoma :" ) 
        print( " For instance : tahoma open shutter kitchen arm alarm garden on plug room wait train garestation " )
        print( "" )
        print( " To install tahoma you will need to execute tahoma -c and tahoma -g :")
    ...
    for arg in sys.argv :
        if arg == '-c' or arg == '--configure' :
            ...
            if serverchoice == "somfy_europe" or serverchoice == "somfy_america" or serverchoice == "somfy_oceania" :
                ...
                f.close() 
            print( "" )
            print( "Please provide somfy-connect's USERNAME for tahoma (mail address) : \nIt will be stored here : \n"+passwd_file+"\nIf you don't want to store it localy, you can leave it empty, but you will need to connect with the --username or -u argument each time")
            USERNAME = input()
            print( "" )
            print( "Please provide somfy-connect's PASSWORD for tahoma : \nIt will be stored here : \n"+passwd_file+"\nYou can leave it empty, but you will need to connect with the --password or -p argument each time")
            PASSWORD = getpass()
            print( "" )
