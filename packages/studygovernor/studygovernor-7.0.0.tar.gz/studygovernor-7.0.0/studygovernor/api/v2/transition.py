...
from .summary_models import state_summary, transition_summary
...
transition_list = api.model('TransitionList', {
    'transitions': fields.List(fields.Nested(transition_summary))
})
...
transition = api.model('Transition', {
    ...
    'destination_state': fields.Nested(state_summary),
    'source_state': fields.Nested(state_summary),
