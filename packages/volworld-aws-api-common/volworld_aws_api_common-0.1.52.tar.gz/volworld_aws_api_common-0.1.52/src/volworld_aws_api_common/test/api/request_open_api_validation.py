...
def request_open_api_validation(url: str, req, resp_json, resp: Response, attList):
...
def post_request_with_validation(
    ...
    request_open_api_validation(url, req, resp_json, resp, attList)
...
def get_request_with_validation(
    ...
    request_open_api_validation(url, None, resp_json, resp, attList)
    return resp_json, resp