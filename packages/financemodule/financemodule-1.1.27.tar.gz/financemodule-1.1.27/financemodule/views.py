...
class FinanceModuleHandler:
    ...
    def gets_loan_account(self):
        return Loanaccount.objects.get_or_create(customer = self.anchor_party , program_type = self.program_type , currency = self.finance_currency)
    ...
    def gets_interest_account(self):
        ...
        return Interestaccount.objects.get_or_create(program_type=self.program_type , currency=self.finance_currency )
