...
class KDC101(APTDevice_Motor):
    ...
    def __init__(self, serial_port=None, vid=None, pid=None, manufacturer=None, product=None, serial_number="83",
        ...
        super().__init__(serial_port=serial_port, vid=vid, pid=pid, manufacturer=manufacturer, product=product,
                         ...
                         status_updates="auto", controller=None, bays=(EndPoint.USB,), channels=(1,))
