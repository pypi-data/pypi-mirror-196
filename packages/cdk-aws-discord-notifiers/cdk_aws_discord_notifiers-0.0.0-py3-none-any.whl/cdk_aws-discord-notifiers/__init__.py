...
class MonthlyCostNotifier(
    ...
    def __init__(
        ...
        *,
        ...
        :param webhook_token: The webhook token to post to.
...
class MonthlyCostNotifierProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument webhook_token", value=webhook_token, expected_type=type_hints["webhook_token"])
    ...
    def webhook_token(self) -> builtins.str:
        ...
        result = self._values.get("webhook_token")
        assert result is not None, "Required property 'webhook_token' is missing"
        return typing.cast(builtins.str, result)
