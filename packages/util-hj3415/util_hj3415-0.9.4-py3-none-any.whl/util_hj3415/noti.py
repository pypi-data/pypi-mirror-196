...
CHAT_ID = '924939307'
BOT_LIST = ['manager', 'dart', 'eval', 'cybos', 'servers']
...
def telegram_to(botname: str, text: str, parse_html: bool = False) -> bool:
    ...
    if botname in BOT_LIST:
        ...
        elif botname == 'servers':
            token = '5601845727:AAEKD-HK4R2XyvwmOeqU-3E0_iRw9AtNxxo'
        else:
        ...
        while trying < 3:
            try:
                ...
                print(f'Sent message to {botname} bot successfully.')
                return True
            except:
                time.sleep(1)
                trying += 1
