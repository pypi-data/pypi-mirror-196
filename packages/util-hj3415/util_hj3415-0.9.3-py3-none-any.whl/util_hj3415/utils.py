...
def get_driver(temp_dir: str = '', headless=True) -> webdriver.chrome.webdriver.WebDriver:
    """ 크롬 드라이버를 반환
    ...
    try:
        ...
        print("Fail to get chrome driver..", file=sys.stderr)
        return None
    else:
...
def code_divider(entire_codes: list) -> Tuple[int, list]:
