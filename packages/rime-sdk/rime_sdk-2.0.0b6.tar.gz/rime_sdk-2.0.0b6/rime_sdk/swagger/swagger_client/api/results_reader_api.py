...
class ResultsReaderApi(object):
    ...
    def results_reader_get_feature_result(self, test_run_id, feature_url, **kwargs):  # noqa: E501
        """GetFeatureResult  # noqa: E501

        Returns the feature result that matches the specified test run ID and feature ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.results_reader_get_feature_result(test_run_id, feature_url, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str test_run_id: Uniquely specifies a Test Run. (required)
        :param str feature_url: Uniquely specifies a Feature. (required)
        :param bool show_display: Boolean flag for toggling whether to return display html info with message.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.results_reader_get_feature_result_with_http_info(test_run_id, feature_url, **kwargs)  # noqa: E501
        else:
            (data) = self.results_reader_get_feature_result_with_http_info(test_run_id, feature_url, **kwargs)  # noqa: E501
            return data

    def results_reader_get_feature_result_with_http_info(self, test_run_id, feature_url, **kwargs):  # noqa: E501
        """GetFeatureResult  # noqa: E501

        Returns the feature result that matches the specified test run ID and feature ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.results_reader_get_feature_result_with_http_info(test_run_id, feature_url, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['test_run_id', 'feature_url', 'show_display']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'feature_url' is set
        if ('feature_url' not in params or
                params['feature_url'] is None):
            raise ValueError("Missing the required parameter `feature_url` when calling `results_reader_get_feature_result`")  # noqa: E501
        ...
        if 'feature_url' in params:
            path_params['featureUrl'] = params['feature_url']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/test-runs/{testRunId}/feature-result/{featureUrl}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def results_reader_list_batch_results(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str test_run_id: ID of the Test Run associated with batch results. Specify no more than one of either this field or the pageToken field.
        :param str page_token: Specifies a page of the list returned by a ListBatchResults query. The ListBatchResults query returns a pageToken when there is more than one page of results. Specify either this field or the testRunId field.
    ...
    def results_reader_list_feature_results(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str test_run_id: ID of the Test Run associated with feature results. Specify no more than one of either this field or the pageToken field.
        :param str page_token: Specifies a page of the list returned by a ListFeatureResults query. The ListFeatureResults query returns a pageToken when there is more than one page of results. Specify either this field or the testRunId field.
    ...
    def results_reader_list_summary_tests(self, **kwargs):  # noqa: E501
        ...
        :param str page_token: Specifies a page of the list returned by a ListSummaryTests query. The ListSummaryTests query returns a pageToken when there is more than one page of results. Specify either this field or the query.testRunId field.
    ...
    def results_reader_list_test_cases(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str list_test_cases_query_test_run_id: Uniquely specifies a Test Run associated with test cases. Specify no more than one of either this field or the pageToken field.
        ...
        :param str page_token: Specifies a page of the list returned by a ListTestCases query. The ListTestCases query returns a pageToken when there is more than one page of results. Specify either this field or the ListTestCasesQuery.testRunId field.
    ...
    def results_reader_list_test_runs(self, **kwargs):  # noqa: E501
        ...
        :param str page_token: Specifies a page of the list returned by a ListTestRuns query. The ListTestRuns query returns a pageToken when there is more than one page of results. Specify either this field or the projectId field.
