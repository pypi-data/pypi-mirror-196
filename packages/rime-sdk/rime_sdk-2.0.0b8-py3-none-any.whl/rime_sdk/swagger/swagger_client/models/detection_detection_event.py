...
class DetectionDetectionEvent(object):
    ...
    def __init__(self, id=None, project_id=None, firewall_id=None, event_type=None, severity=None, event_object_id=None, event_object_name=None, event_time_range=None, last_update_time=None, risk_category_type=None, test_category=None, description=None, resolution=None, detail=None, rca_role=None):  # noqa: E501
