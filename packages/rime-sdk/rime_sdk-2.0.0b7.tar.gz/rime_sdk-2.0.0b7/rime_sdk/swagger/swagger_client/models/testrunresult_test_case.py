...
class TestrunresultTestCase(object):
    ...
    def __init__(self, test_run_id=None, features=None, test_batch_type=None, status=None, severity=None, importance_score=None, category=None, metrics=None, url_safe_feature_id=None, test_case_id=None, display=None):  # noqa: E501
