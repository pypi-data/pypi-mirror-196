...
class RimeListDetectionEventsRequestQuery(object):
    ...
    swagger_types = {
        ...
        'test_category_types': 'list[TestrunTestCategoryType]',
        'sort': 'RimeSortSpec'
    }
    ...
    attribute_map = {
        ...
        'test_category_types': 'testCategoryTypes',
        'sort': 'sort'
    }

    def __init__(self, firewall_id=None, event_object_id=None, event_time_range=None, severity=None, event_types=None, risk_category_types=None, test_category_types=None, sort=None):  # noqa: E501
        ...
        self._test_category_types = None
        self._sort = None
        ...
        if test_category_types is not None:
            self.test_category_types = test_category_types
        if sort is not None:
            self.sort = sort
    ...
    def test_category_types(self):
        """Gets the test_category_types of this RimeListDetectionEventsRequestQuery.  # noqa: E501

        Optional: When the list is empty, return all.  # noqa: E501

        :return: The test_category_types of this RimeListDetectionEventsRequestQuery.  # noqa: E501
        :rtype: list[TestrunTestCategoryType]
        """
        return self._test_category_types

    @test_category_types.setter
    def test_category_types(self, test_category_types):
        """Sets the test_category_types of this RimeListDetectionEventsRequestQuery.

        Optional: When the list is empty, return all.  # noqa: E501

        :param test_category_types: The test_category_types of this RimeListDetectionEventsRequestQuery.  # noqa: E501
        :type: list[TestrunTestCategoryType]
        """

        self._test_category_types = test_category_types
