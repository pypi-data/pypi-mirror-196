...
def compliance_summary(prismasession: PrismaSession, standards: list[str], return_json=False):
    """
...
def compliance_requirements_summary(prismasession: PrismaSession, standard:str, account_name = None, return_json=False):
    """
...
def resource_compliance(prismasession, complianceStandard, return_json=False):
    """
...
def historic(prismasession: PrismaSession, complianceStandard: str, cloudAccounts: list[str] = None, accountGroups: list[str] = None):
    """
...
def get_group_accounts_ids_by_names(prismaSession: PrismaSession, groupAccountNames: list[str]):
    ids = []
...
def resources_usage_over_time(prismaSession, accounts_ids: list[str], start_date: str = None,
                              end_date: str = None, return_json=False):
    """
...
def query(prismasession: prisma.PrismaSession, query: str = None, timerange = None):
    """
