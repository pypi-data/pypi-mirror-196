...
def alerts(prismasession: prisma.PrismaSession, basic = True, timeType = 'relative', timeAmount = '2',
           ...
           alertRuleName = None, resourceId = None, resourceName = None, resourceType = None):
    """
