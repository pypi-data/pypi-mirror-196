...
@refreshToken
def list_cloud_accounts_names(prismaSession: PrismaSession, onlyActive: bool = False, accountGroupIds: list[str] = None, cloud_type: str = None):
    """
...
def config_search(prismaSession: PrismaSession, query: str, timerange) -> json:
    """
