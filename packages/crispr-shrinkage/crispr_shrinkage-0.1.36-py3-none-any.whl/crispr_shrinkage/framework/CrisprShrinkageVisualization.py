...
def normalize_shape_size(input_shape_sizes: List[Union[int,float]], all_shape_sizes: Union[List[Union[int,float]], None], max_shape_size: Union[int,float]):
...
def visualize_raw_and_adjusted_score_by_position_scatter(crispr_shrinkage_visualization_input: CrisprShrinkageVisualizationInput, max_shape_size = 10):
    for rep_i in crispr_shrinkage_visualization_input.replicate_indices:
        plt.scatter(crispr_shrinkage_visualization_input.explanatory_positions, crispr_shrinkage_visualization_input.explanatory_lfc_rep[rep_i], s=normalize_shape_size(crispr_shrinkage_visualization_input.explanatory_count_rep[rep_i], max_shape_size=max_shape_size))
        plt.title("Adjusted LFC")
        plt.show()
        plt.scatter(crispr_shrinkage_visualization_input.explanatory_positions, crispr_shrinkage_visualization_input.explanatory_raw_lfc_rep[rep_i], s=normalize_shape_size(crispr_shrinkage_visualization_input.explanatory_count_rep[rep_i], max_shape_size=max_shape_size))
        plt.title("Raw LFC")
        plt.show()
...
def visualize_combined_adjusted_score_by_position_scatter(crispr_shrinkage_visualization_input: CrisprShrinkageVisualizationInput, max_shape_size = 10):
    ...
    for rep_i in crispr_shrinkage_visualization_input.replicate_indices:
        ax.scatter(crispr_shrinkage_visualization_input.explanatory_positions, crispr_shrinkage_visualization_input.explanatory_lfc_rep[rep_i], s=normalize_shape_size(crispr_shrinkage_visualization_input.explanatory_count_rep[rep_i], max_shape_size=max_shape_size), alpha=0.3, label="Replicate {}".format(rep_i))
...
def visualize_all_adjusted_score_credible_interval_by_position_scatter(crispr_shrinkage_visualization_input: CrisprShrinkageVisualizationInput, max_shape_size = 10):
    for rep_i in crispr_shrinkage_visualization_input.replicate_indices:
        ...
        ax.scatter(crispr_shrinkage_visualization_input.explanatory_positions,explanatory_lfc_rep_rep_standardized, s=normalize_shape_size(crispr_shrinkage_visualization_input.explanatory_count_rep[rep_i], max_shape_size=max_shape_size), color="blue", alpha=0.85, label="Adjusted")
        ax.scatter(crispr_shrinkage_visualization_input.explanatory_positions,explanatory_raw_lfc_rep_standardized, s=normalize_shape_size(crispr_shrinkage_visualization_input.explanatory_count_rep[rep_i], max_shape_size=max_shape_size), color="black", alpha=0.85, label="Raw") # Can color based on which of the guides are in the observational set and which are not (specifically which are in the positive, negative.
...
def visualize_raw_and_adjusted_score_by_position_scatter_multiple(crispr_shrinkage_visualization_input_list: List[CrisprShrinkageVisualizationInput], input_label_list: List[str], max_shape_size = 10):
    ...
    for rep_i in crispr_shrinkage_visualization_input_list[0].replicate_indices:
        ...
        for input_index in range(len(crispr_shrinkage_visualization_input_list)):
            ...
            normalized_count = normalize_shape_size(crispr_shrinkage_visualization_input.explanatory_count_rep[rep_i], np.concatenate([crispr_shrinkage_visualization_input_i.explanatory_count_rep[rep_i] for crispr_shrinkage_visualization_input_i in crispr_shrinkage_visualization_input_list]), max_shape_size)
