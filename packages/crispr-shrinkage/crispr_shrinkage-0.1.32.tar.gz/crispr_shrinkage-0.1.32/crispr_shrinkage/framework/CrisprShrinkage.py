...
def singleton_imputation_weighted_objective_function_of_all_guides(rep_i: int,
                                                        ...
                                                        KL_guide_set_weights: Union[List[float], None],
                                                        params: float):
            KL_guide_imputation_score_total_combined_avg, KL_guide_imputation_score_total_negative_avg, KL_guide_imputation_score_total_positive_avg, KL_guide_imputation_score_total_observation_avg = SingletonImputationOptimizer.singleton_imputation_objective_function_of_all_guides(rep_i, experiment_guide_sets, negative_control_guide_sample_population_total_normalized_counts_reps, negative_control_guide_control_population_total_normalized_counts_reps, params)
...
class SingletonImputationOptimizer:
    ...
    def optimize_singleton_imputation_prior_strength(
        ...
        for rep_i in replicate_indices:
            ...
            res = scipy.optimize.differential_evolution(weighted_objective_function_of_all_guides_p, bounds=[(0.000001, optimizer_upper_bound)], callback=store_values, maxiter= 10000, tol=0.005, workers=cores) 
...
class NeighborhoodImputationOptimizer:
    ...
    def optimize_neighborhood_imputation_prior_strength(
        ...
        for rep_i in replicate_indices:
            weighted_objective_function_of_all_guides_p = functools.partial(neighborhood_imputation_weighted_objective_function_of_all_guides, rep_i, experiment_guide_sets, negative_control_guide_sample_population_total_normalized_counts_reps, negative_control_guide_control_population_total_normalized_counts_reps, neighborhood_bandwidth, deviation_weights, KL_guide_set_weights)
            ...
            res = scipy.optimize.differential_evolution(weighted_objective_function_of_all_guides_p, bounds=[(0.000001, optimizer_upper_bound),(0.000001, optimizer_upper_bound)], callback=store_values, tol=0.005, workers=cores) 
