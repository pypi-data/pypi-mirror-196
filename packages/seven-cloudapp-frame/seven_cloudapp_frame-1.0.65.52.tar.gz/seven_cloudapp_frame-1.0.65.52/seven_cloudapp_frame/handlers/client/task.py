...
@LastEditTime: 2023-03-01 18:38:25
...
class FreeGiftHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        continue_request_expire = invoke_result_data.data["continue_request_expire"] if invoke_result_data.data.__contains__("continue_request_expire") else 5
        is_stat = invoke_result_data.data["is_stat"] if invoke_result_data.data.__contains__("is_stat") else True
        is_receive_reward = invoke_result_data.data["is_receive_reward"] if invoke_result_data.data.__contains__("is_receive_reward") else True  #是否直接领取奖励
        info_json = invoke_result_data.data["info_json"] if invoke_result_data.data.__contains__("info_json") else None
        invoke_result_data = task_base_model.process_free_gift(app_id, act_id, module_id, user_id, login_token, self.__class__.__name__, self.request_code, check_new_user, check_user_nick, continue_request_expire, is_stat, info_json, is_receive_reward)
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
        ref_params = {}
        invoke_result_data = self.business_process_executed(invoke_result_data, ref_params)
...
class OneSignHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        invoke_result_data = task_base_model.process_one_sign(app_id, act_id, module_id, user_id, login_token, self.__class__.__name__, self.request_code, check_new_user, check_user_nick, continue_request_expire, is_stat, info_json, is_receive_reward)
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
        ref_params = {}
        invoke_result_data = self.business_process_executed(invoke_result_data, ref_params)
...
class CumulativeSignHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        is_receive_reward = invoke_result_data.data["is_receive_reward"] if invoke_result_data.data.__contains__("is_receive_reward") else True  #是否直接领取奖励
        info_json = invoke_result_data.data["info_json"] if invoke_result_data.data.__contains__("info_json") else None
        invoke_result_data = task_base_model.process_cumulative_sign(app_id, act_id, module_id, user_id, login_token, self.__class__.__name__, self.request_code, check_new_user, check_user_nick, continue_request_expire, is_stat, info_json, is_receive_reward)
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
        ref_params = {}
        invoke_result_data = self.business_process_executed(invoke_result_data, ref_params)
...
class InviteNewUserHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        if is_receive_reward == True:
            invoke_result_data = task_base_model.process_receive_reward(app_id=app_id, act_id=act_id, module_id=module_id, user_id=from_user_id, login_token='', task_id=0, task_sub_type='', handler_name=self.__class__.__name__, request_code=self.request_code, task_type=4, check_new_user=False, check_user_nick=False, continue_request_expire=0, is_stat=True, info_json=None, check_act_info_release=False, check_act_module_release=False)
...
class InviteJoinMemberHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        invoke_result_data = task_base_model.process_invite_join_member(app_id, act_id, module_id, user_id, login_token, from_user_id, self.__class__.__name__, check_user_nick, continue_request_expire, close_invite_limit)
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
        ref_params = {}
        invoke_result_data = self.business_process_executed(invoke_result_data, ref_params)
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
        if is_receive_reward == True:
            invoke_result_data = task_base_model.process_receive_reward(app_id=app_id, act_id=act_id, module_id=module_id, user_id=from_user_id, login_token='', task_id=0, task_sub_type='', handler_name=self.__class__.__name__, request_code=self.request_code, task_type=5, check_new_user=False, check_user_nick=False, continue_request_expire=0, is_stat=True, info_json=None, check_act_info_release=False, check_act_module_release=False)
            if invoke_result_data.success == True:
                return self.response_json_success(invoke_result_data.data)
        return self.response_json_success(0)
...
class CollectGoodsHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
        if is_receive_reward == True:
            invoke_result_data = task_base_model.process_receive_reward(app_id=app_id, act_id=act_id, module_id=module_id, user_id=user_id, login_token=login_token, task_id=0, task_sub_type='', handler_name=self.__class__.__name__, request_code=self.request_code, task_type=8, check_new_user=False, check_user_nick=False, continue_request_expire=0, is_stat=True, info_json=None, check_act_info_release=False, check_act_module_release=False)
            if invoke_result_data.success == True:
                return self.response_json_success(invoke_result_data.data)
        return self.response_json_success(0)
...
class BrowseGoodsHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
        if is_receive_reward == True:
            invoke_result_data = task_base_model.process_receive_reward(app_id=app_id, act_id=act_id, module_id=module_id, user_id=user_id, login_token=login_token, task_id=0, task_sub_type='', handler_name=self.__class__.__name__, request_code=self.request_code, task_type=9, check_new_user=False, check_user_nick=False, continue_request_expire=0, is_stat=True, info_json=None, check_act_info_release=False, check_act_module_release=False)
            if invoke_result_data.success == True:
                return self.response_json_success(invoke_result_data.data)
        return self.response_json_success(0)
...
class FavorStoreHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        is_receive_reward = invoke_result_data.data["is_receive_reward"] if invoke_result_data.data.__contains__("is_receive_reward") else True  #是否直接领取奖励
        info_json = invoke_result_data.data["info_json"] if invoke_result_data.data.__contains__("info_json") else None
        invoke_result_data = task_base_model.process_favor_store(app_id, act_id, module_id, user_id, login_token, self.__class__.__name__, self.request_code, check_user_nick, continue_request_expire, is_stat, info_json, is_receive_reward)
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
        ref_params = {}
        invoke_result_data = self.business_process_executed(invoke_result_data, ref_params)
...
class JoinMemberHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        is_receive_reward = invoke_result_data.data["is_receive_reward"] if invoke_result_data.data.__contains__("is_receive_reward") else True  #是否直接领取奖励
        info_json = invoke_result_data.data["info_json"] if invoke_result_data.data.__contains__("info_json") else None
        invoke_result_data = task_base_model.process_join_member(app_id, act_id, module_id, user_id, login_token, self.__class__.__name__, self.request_code, check_user_nick, continue_request_expire, is_stat, info_json, is_receive_reward)
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
        ref_params = {}
        invoke_result_data = self.business_process_executed(invoke_result_data, ref_params)
...
class ShareHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
        if is_receive_reward == True:
            invoke_result_data = task_base_model.process_receive_reward(app_id=app_id, act_id=act_id, module_id=module_id, user_id=user_id, login_token=login_token, task_id=0, task_sub_type='', handler_name=self.__class__.__name__, request_code=self.request_code, task_type=14, check_new_user=False, check_user_nick=False, continue_request_expire=0, is_stat=True, info_json=None, check_act_info_release=False, check_act_module_release=False)
            if invoke_result_data.success == True:
                return self.response_json_success(invoke_result_data.data)
        return self.response_json_success(0)
