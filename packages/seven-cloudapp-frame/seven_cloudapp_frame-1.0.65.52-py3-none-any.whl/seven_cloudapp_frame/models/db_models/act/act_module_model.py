...
@LastEditTime: 2022-09-27 18:05:58
...
class ActModule:
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'act_id', 'business_type', 'module_name', 'module_sub_name', 'start_date', 'end_date', 'skin_id', 'module_pic', 'module_desc', 'price', 'price_gear_id', 'ip_id', 'join_ways', 'is_fictitious', 'sort_index', 'is_release', 'release_date', 'create_date', 'modify_date', 'is_del', 'i1', 'i2', 'i3', 'i4', 'i5', 's1', 's2', 's3', 's4', 's5', 'd1', 'd2']
