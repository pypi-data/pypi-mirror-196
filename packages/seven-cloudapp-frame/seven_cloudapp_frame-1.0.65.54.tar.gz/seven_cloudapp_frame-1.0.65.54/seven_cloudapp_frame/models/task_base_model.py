...
@LastEditTime: 2023-03-10 11:24:20
...
class TaskBaseModel(FrameBaseModel):
    ...
    def process_free_gift(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5,is_stat=True,info_json=None,is_receive_reward=True):
        """
        ...
        :param is_stat:是否统计上报
        :param info_json:资产日志详细信息
        :param is_receive_reward:是否领取奖励
        :return 
        :last_editors: HuangJianYi
        """
        invoke_result_data = InvokeResultData()
            ...
            if invoke_result_data.success == True:
                ...
                if task_invoke_result_data.success == True:
                    ...
                    if is_limit == True:
                        ...
                        if reward_value > 0 and is_receive_reward == True:
    ...
    def process_one_sign(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5,is_stat=True,info_json=None,is_receive_reward=True):
        """
    ...
    def process_weekly_sign(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5,is_stat=True,info_json=None,check_act_info_release=True,check_act_module_release=True,is_receive_reward=True):
        """
        :description: 处理每周签到(指定天数签到)任务
        :param app_id:应用标识
        :param act_id:活动标识
        :param module_id:活动模块标识
        :param user_id:用户标识
    ...
    def process_cumulative_sign(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5,is_stat=True,info_json=None,is_receive_reward=True):
        """
    ...
    def process_favor_store(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_user_nick=True,continue_request_expire=5,is_stat=True,info_json=None,is_receive_reward=True):
        """
    ...
    def process_join_member(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_user_nick=True,continue_request_expire=5,is_stat=True,info_json=None,is_receive_reward=True):
        """
