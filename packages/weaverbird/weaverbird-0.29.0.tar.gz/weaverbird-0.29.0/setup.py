...
install_requires = \
['pydantic>=1.9.1,<2.0.0', 'pytest-xdist>=2.5,<4.0']
...
{'all': ['pandas>=1.2.5,<2.0.0',
 ...
 'playground': ['pandas>=1.2.5,<2.0.0',
                ...
                'toucan-connectors[google-big-query,mongo,redshift,snowflake]>=4.4.0,<5.0.0'],
 'playground:python_version < "3.11"': ['awswrangler>=2.20.0,<3.0.0'],
