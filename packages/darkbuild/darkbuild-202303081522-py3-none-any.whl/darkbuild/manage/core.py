...
from darkbuild.shell import run_shell


class ServerManage:
    def __init__(self):
        self.manage_conf_path = "/darkchats/darkbuild/supervisord.conf"
        self.conf_dir = "/darkchats/darkbuild/conf"
...
files = {self.conf_dir}/*.ini
    ...
    def add_job(self, server_name, directory, command, user='bingtao', stdout_logfile=None):
        default_logfile = f'/darkchats/logs/darkbuild/{server_name}.log'
