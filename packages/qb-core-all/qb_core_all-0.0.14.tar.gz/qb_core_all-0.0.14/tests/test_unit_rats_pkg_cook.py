...
from qb_core.rats_pkg.cook.cook_persistence_interface import CookPersistenceInterface
...
def setup_cook_persistence():
    ...
    _cook_persistence = PersistencePluginManager.get_persistence_implementation("cook_persistence_interface")
...
def test_cook_persistence_interface():
