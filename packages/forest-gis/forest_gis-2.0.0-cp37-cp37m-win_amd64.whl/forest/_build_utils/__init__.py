...
def cythonize_extensions(top_path, config):
    ...
    # The result of this check is cached as a private attribute on the forest
    ...
    forest._OPENMP_SUPPORTED = check_openmp_support()
    ...
    config.ext_modules = cythonize(
        ...
        nthreads=n_jobs,
        compile_time_env={
            'SKLEARN_OPENMP_PARALLELISM_ENABLED': forest._OPENMP_SUPPORTED},
