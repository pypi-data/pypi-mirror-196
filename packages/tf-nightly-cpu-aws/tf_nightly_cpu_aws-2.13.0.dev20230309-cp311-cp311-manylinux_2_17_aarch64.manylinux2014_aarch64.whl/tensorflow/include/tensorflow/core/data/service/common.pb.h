...
class SnapshotTaskProgress final :
 ...
 public:
  ...
  // .tensorflow.error.Code error_code = 3;
...
// .tensorflow.error.Code error_code = 3;
inline void SnapshotTaskProgress::clear_error_code() {
  _impl_.error_code_ = 0;
}
inline ::tensorflow::error::Code SnapshotTaskProgress::_internal_error_code() const {
  return static_cast< ::tensorflow::error::Code >(_impl_.error_code_);
}
inline ::tensorflow::error::Code SnapshotTaskProgress::error_code() const {
  // @@protoc_insertion_point(field_get:tensorflow.data.SnapshotTaskProgress.error_code)
  return _internal_error_code();
}
inline void SnapshotTaskProgress::_internal_set_error_code(::tensorflow::error::Code value) {
  
  _impl_.error_code_ = value;
}
inline void SnapshotTaskProgress::set_error_code(::tensorflow::error::Code value) {
  _internal_set_error_code(value);
  // @@protoc_insertion_point(field_set:tensorflow.data.SnapshotTaskProgress.error_code)
}

// string error_message = 4;
inline void SnapshotTaskProgress::clear_error_message() {
  _impl_.error_message_.ClearToEmpty();
}
inline const std::string& SnapshotTaskProgress::error_message() const {
  // @@protoc_insertion_point(field_get:tensorflow.data.SnapshotTaskProgress.error_message)
  return _internal_error_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SnapshotTaskProgress::set_error_message(ArgT0&& arg0, ArgT... args) {
 
 _impl_.error_message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:tensorflow.data.SnapshotTaskProgress.error_message)
}
inline std::string* SnapshotTaskProgress::mutable_error_message() {
  std::string* _s = _internal_mutable_error_message();
  // @@protoc_insertion_point(field_mutable:tensorflow.data.SnapshotTaskProgress.error_message)
  return _s;
}
inline const std::string& SnapshotTaskProgress::_internal_error_message() const {
  return _impl_.error_message_.Get();
}
inline void SnapshotTaskProgress::_internal_set_error_message(const std::string& value) {
  
  _impl_.error_message_.Set(value, GetArenaForAllocation());
}
inline std::string* SnapshotTaskProgress::_internal_mutable_error_message() {
  
  return _impl_.error_message_.Mutable(GetArenaForAllocation());
}
inline std::string* SnapshotTaskProgress::release_error_message() {
  // @@protoc_insertion_point(field_release:tensorflow.data.SnapshotTaskProgress.error_message)
  return _impl_.error_message_.Release();
}
inline void SnapshotTaskProgress::set_allocated_error_message(std::string* error_message) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:tensorflow.data.SnapshotTaskProgress.error_message)
}
