...
VERSION = "0.1.0"
DESCRIPTION = "UNOFFICIAL Python bindings for Proxyrack Dashboard API"
LONG_DESCRIPTION = "A package that allows you to connect to Proxyrack API and interact with your data."
...
setup(
    ...
    url = "https://github.com/coder-amogh/pyProxyrack",
    project_urls = {
