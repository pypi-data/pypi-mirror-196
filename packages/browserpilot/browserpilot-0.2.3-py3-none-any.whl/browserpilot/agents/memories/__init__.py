"""Memory for agents."""
from llama_index import Document, GPTSimpleVectorIndex, GPTSimpleKeywordTableIndex
from llama_index.langchain_helpers.chatgpt import ChatGPTLLMPredictor

# https://gpt-index.readthedocs.io/en/latest/guides/index_guide.html
INDEX_TYPES = {
    "simple": GPTSimpleVectorIndex,
    "keyword": GPTSimpleKeywordTableIndex,
}
...
class Memory:
    def __init__(self, *args, **kwargs):
        ...
        index_type = kwargs.get("index_type", "keyword")
    ...
    def query(self, prompt):
        ...
        return self.index.query(prompt, llm_predictor=llm_predictor)
