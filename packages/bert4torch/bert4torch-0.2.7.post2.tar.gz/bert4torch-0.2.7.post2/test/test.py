...
tokenizer = T5Tokenizer.from_pretrained("F:/Projects/pretrain_ckpt/t5/[ClueAI_t5_torch_large]--ClueAI-ChatYuan-large-v1")
model = T5ForConditionalGeneration.from_pretrained("F:/Projects/pretrain_ckpt/t5/[ClueAI_t5_torch_large]--ClueAI-ChatYuan-large-v1")
