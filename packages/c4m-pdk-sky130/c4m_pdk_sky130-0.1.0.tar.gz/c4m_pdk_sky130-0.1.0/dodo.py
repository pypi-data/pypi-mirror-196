...
def task_rtl():
    ...
    def rtl_script(lib, lang):
        avt_shell_script = dedent(f"""
            ...
            avt_LoadFile "{python_models_dir.joinpath("C4M.Sky130_logic_tt_model.spice")}" spice
            avt_LoadFile "{python_models_dir.joinpath("C4M.Sky130_io_tt_model.spice")}" spice
