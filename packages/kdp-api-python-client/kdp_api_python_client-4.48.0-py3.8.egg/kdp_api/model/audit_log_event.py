...
class AuditLogEvent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, timestamp, dataset_id, *args, **kwargs):  # noqa: E501
        """AuditLogEvent - a model defined in OpenAPI

        Args:
            id (str): event ID
            type (str):
            timestamp (int): event timestamp - UTC - Required. Number of milliseconds since the Unix epoch (January 1, 1970, 00:00:00 UTC).
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, type, timestamp, dataset_id, *args, **kwargs):  # noqa: E501
        """AuditLogEvent - a model defined in OpenAPI
