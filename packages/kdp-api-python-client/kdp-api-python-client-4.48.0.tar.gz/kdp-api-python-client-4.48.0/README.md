...
*AuditLogApi* | [**get_all_auditlog_configurations**](docs/AuditLogApi.md#get_all_auditlog_configurations) | **GET** /audit-log-configs/ | Get all audit log configuration of all workspaces
*AuditLogApi* | [**get_auditlog_configuration**](docs/AuditLogApi.md#get_auditlog_configuration) | **GET** /audit-log-configs/{logConfigurationId} | Get audit log configuration of a workspace
*AuditLogApi* | [**patch_auditlog_configuration**](docs/AuditLogApi.md#patch_auditlog_configuration) | **PATCH** /audit-log-configs/{auditLogConfigsId} | Patch audit log configuration of a workspace
...
*AuditLogApi* | [**put_auditlog_configuration**](docs/AuditLogApi.md#put_auditlog_configuration) | **PUT** /audit-log-configs/{auditLogConfigsId} | Modify audit log configuration of a workspace
