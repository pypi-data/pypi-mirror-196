# Generated from ProtobufParser.g4 by ANTLR 4.12.0
from antlr4 import *
...
class ProtobufParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ProtobufParser#fieldDecl.
    def enterFieldDecl(self, ctx:ProtobufParser.FieldDeclContext):
        pass

    # Exit a parse tree produced by ProtobufParser#fieldDecl.
    def exitFieldDecl(self, ctx:ProtobufParser.FieldDeclContext):
        pass
    ...
    # Enter a parse tree produced by ProtobufParser#ident.
    def enterIdent(self, ctx:ProtobufParser.IdentContext):
        pass

    # Exit a parse tree produced by ProtobufParser#ident.
    def exitIdent(self, ctx:ProtobufParser.IdentContext):
        pass
