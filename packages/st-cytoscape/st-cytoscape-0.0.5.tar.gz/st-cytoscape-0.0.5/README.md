...
`st-cytoscape` also includes the `cytoscape-klay` [add-on](https://github.com/cytoscape/cytoscape.js-klay) for Cytoscape.js. To use it, simply mention `klay` in the layout:
