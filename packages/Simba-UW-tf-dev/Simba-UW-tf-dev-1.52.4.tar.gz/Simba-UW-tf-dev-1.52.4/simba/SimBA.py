...
class loadprojectini:
    def __init__(self,
        ...
        button_importframefolder = Button(label_importframefolder,text='Import frames',command=lambda:self.importframefolder)
    ...
    def importframefolder(self):
        if (self.projectconfigini!='No file selected') and (self.frame_folder.folder_path != 'No folder selected'):
            copy_img_folder(config_path=self.projectconfigini, source=self.frame_folder.folder_path)
        else:
