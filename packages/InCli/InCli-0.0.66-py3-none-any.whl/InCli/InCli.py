...
def option_ipa(args):
    ...
    if check_modifiers('-ipa',args,["-file","-limit","-nf"],help) == False: return
    ...
    limit = 100 if limit == None else limit
    ip_attachments.print_attachments(limit=limit,only_not_finished=nf)
...
def option_logs(args):
    ...
    if check_modifiers('-logs',args,["-last","-tail","-store","-deletelogs","-limit","-limitinfo","-auto","-folder","-level","-loguser","-where","-inputfile","-file","-error"],help) == False: return
