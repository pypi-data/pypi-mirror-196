...
class Automation_345_cv:
	...
	def __init__(self, s, t, pc_cv, d_pu, m, cof, f_res, j_pu, j_mot, j_gb, gr, t_idle):
		...
		self.curveGen = polynomial_345_cv.Polynomial_345_cv(self.s, self.t, self.t_idle, self.pc_cv)
...
# axis1 = Automation_345_cv(1200, 2, 0.5, 90, 50, 0.02, 500, 0.02, 0.005, 0.003, 10, 0.5)
