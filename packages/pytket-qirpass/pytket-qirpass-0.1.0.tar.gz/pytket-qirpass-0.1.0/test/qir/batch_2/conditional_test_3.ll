...
entry:
  ...
  br i1 %0, label %then0__2.i.i.i, label %Microsoft__Quantum__Samples__MeasureDistilledTAtDepth3InX__body.1.exit.1
...
then0__2.i.i.i:                                   ; preds = %then0__2.i.i
  ...
  tail call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 4 to %Qubit*))
  %1 = tail call i1 @__quantum__qis__anynonzero__body(%Result* null, %Result* nonnull inttoptr (i64 1 to %Result*), %Result* nonnull inttoptr (i64 2 to %Result*), %Result* nonnull inttoptr (i64 3 to %Result*))
  br i1 %1, label %then0__2.i.i.i.i, label %Microsoft__Quantum__Samples__MeasureDistilledTAtDepth3InX__body.1.exit.1

then0__2.i.i.i.i:                                   ; preds = %then0__2.i.i
  tail call void @__quantum__qis__reset__body(%Qubit* null)
  tail call void @__quantum__qis__ry__body(double 0x3FEE91F42805715E, %Qubit* null)
  tail call void @__quantum__qis__rz__body(double 0xC015FDBBE9BBA775, %Qubit* null)
  tail call void @__quantum__qis__ry__body(double 0x3FEE91F42805715E, %Qubit* nonnull inttoptr (i64 1 to %Qubit*))
  ...
  tail call void @__quantum__qis__mz__body(%Qubit* nonnull inttoptr (i64 4 to %Qubit*), %Result* nonnull inttoptr (i64 11 to %Result*))
  tail call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 4 to %Qubit*))
  %2 = tail call i1 @__quantum__qis__anynonzero__body(%Result* null, %Result* nonnull inttoptr (i64 1 to %Result*), %Result* nonnull inttoptr (i64 2 to %Result*), %Result* nonnull inttoptr (i64 3 to %Result*))
...
Microsoft__Quantum__Samples__MeasureDistilledTAtDepth3InX__body.1.exit.1:
  br label %Microsoft__Quantum__Samples__MeasureDistilledTAtDepth3InX__body.1.exit.2

Microsoft__Quantum__Samples__MeasureDistilledTAtDepth3InX__body.1.exit.2:
