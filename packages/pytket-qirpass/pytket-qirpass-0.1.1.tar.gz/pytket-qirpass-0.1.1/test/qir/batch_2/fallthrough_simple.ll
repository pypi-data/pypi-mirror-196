...
continue__1.i.i.i:                                ; preds = %then0__1.i.i.i, %entry
  ...
  br i1 %1, label %then0__2.i.i.i, label %TeleportChain__DemonstrateTeleportationUsingPresharedEntanglement__body.1.exit
...
TeleportChain__DemonstrateTeleportationUsingPresharedEntanglement__body.1.exit: ; preds = %continue__1.i.i2.i, %then0__2.i.i3.i
  ...
  %2 = tail call %String* @__quantum__rt__result_to_string(%Result* nonnull inttoptr (i64 5 to %Result*))
  ret void
}
