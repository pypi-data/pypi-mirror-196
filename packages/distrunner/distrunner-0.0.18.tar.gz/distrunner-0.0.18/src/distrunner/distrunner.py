...
class DistRunner(AbstractContextManager):
    ...
    @staticmethod
    def bootstrap_git_to_workers(arguments: tuple) -> str:
        """
        ...
        working_directory = arguments[2]
        reset_git = arguments[3]
    ...
    def start_cluster(self) -> None:
        ...
        if not self._local:
            ...
            self._dask_cluster = dask.distributed.LocalCluster(
                n_workers=self._workers, processes=False
            )
    ...
    def bootstrap_repo(self) -> ModuleType:
        ...
        if self._bootstrap_git_to_workers and self._local:
            ...
            self._process_worker_retries(
                ...
                arguments=(DistRunner.GIT_FILE, DistRunner.GIT_CORE, cwd, True),
            )
