...
class base:
    ...
    def request(self, api_name=None, params={}, data={}, json={}, headers={}, method="GET", url=None, safe=False, domain=True, **kwargs):
...
class baseApixxYent:
    ...
    def request(self, api_name=None, params={}, data={}, json={}, headers={}, method="GET", url=None,domain=True, **kwargs):
