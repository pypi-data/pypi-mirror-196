...
def create(
    ...
    # the above gives [object Object] for each message
    # so we need to replace it with the actual message
    for i in range(messages):
        messages = messages.replace("[object Object]", messages[i]["content"])
