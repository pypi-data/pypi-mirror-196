...
* Data are **organised** in **dataArray/dataList** with attributes
...
* User write models using the existing **model library** or self created models.
  ...
  The model library contains routines e.g. for vectorized quadrature (formel)
  or specialised models for scattering as **formfactor**, **structurefactor**, **dynamic**
