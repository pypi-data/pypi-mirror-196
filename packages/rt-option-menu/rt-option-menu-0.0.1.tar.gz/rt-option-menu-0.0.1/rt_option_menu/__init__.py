...
def rt_option_menu(choices: List[str], options: Dict = {}, key=None) -> str:
    ...
    component_value = _component_func(choices=choices, options=options, key=key, default='')
...
if not _RELEASE:
    ...
    if not selected_choice:
        st.markdown('No selection yet!')
    else:
        st.markdown(f'You selected {selected_choice}!')
