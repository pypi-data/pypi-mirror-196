...
from pbcpg_pipeline.parse_gff import generate_promoter
from pbcpg_pipeline.plot_bedtools import generate_feature_data
from pbcpg_pipeline.methylation_hist import methylation_hist
...
def promoter_methylation(features, bedmethyl, upstream_flank: int = 2000,
                         ...
                         levels=['Min', 'Low', 'Mid', 'High', 'Max'], hist=None,
                         hist_log=False, palette='mako_r'):
