...
<iframe src="/" width="100%" height="900px" srcdoc="{srcdoc}" frameborder="0" allow-forms allow-pointer-lock allow-popups allow-scripts allow-popups-to-escape-sandbox allow-top-navigation-by-user-activation></iframe>
</div>
"""
    html = iframe
    if return_html:
