# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/Utils/05_pnl_calculator.ipynb.

# %% auto 0
__all__ = ['pnl_1X2', 'pnl_ah', 'pnl']

# %% ../../nbs/Utils/05_pnl_calculator.ipynb 3
import mongoengine
import numexpr
import numpy as np
import pandas as pd

# %% ../../nbs/Utils/05_pnl_calculator.ipynb 13
def pnl_1X2(
...
# %% ../../nbs/Utils/05_pnl_calculator.ipynb 18
def pnl_ah(
...
# %% ../../nbs/Utils/05_pnl_calculator.ipynb 22
def pnl(
    selection: np.ndarray,  # The amount invested on each selection; shape n x 5; last 2 are for home/away asian handicap
    odds: np.ndarray,  # market odds in 1|X|2|A1|A2 order; shape n x 5
    obs_gd: np.ndarray,  # Game goal-difference; shape (n,)
