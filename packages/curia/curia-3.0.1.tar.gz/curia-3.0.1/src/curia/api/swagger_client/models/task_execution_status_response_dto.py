...
class TaskExecutionStatusResponseDto(object):
    ...
    def __init__(self, id=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, archived_at=None, version=None, execution_id=None, message=None, type=None, metadata=None):  # noqa: E501
