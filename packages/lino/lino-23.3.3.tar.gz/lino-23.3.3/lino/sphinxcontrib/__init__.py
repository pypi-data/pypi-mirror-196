...
def configure(globals_dict, django_settings_module=None):
    ...
    # intersphinx_mappings['ss'] = ('https://www.synodalsoft.net/', None)
    # intersphinx_mappings['lf'] = (, None)
    # intersphinx_mappings['cg'] = (, None)
    # intersphinx_mappings['ug'] = (, None)
    # intersphinx_mappings['hg'] = (, None)
    # intersphinx_mappings['book'] = (, None)


    interproject.configure(globals_dict, **intersphinx_mappings)
