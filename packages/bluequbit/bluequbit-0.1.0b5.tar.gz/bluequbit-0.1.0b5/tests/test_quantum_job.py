...
def test_quantum_job_no_measurement():
    ...
    assert job_result.error_message == "Circuit has no measurement"
...
def test_quantum_job_when_aspen_not_available():
    ...
    assert (
        ...
        == "Quantum device is offline currently, please try in timeframe 04:00:00 - 06:00:00 UTC or 15:00:00 - 18:00:00 UTC"
    )
