...
from visualscript.editor.core.models.node import Node
from visualscript.editor.core.models.socket import Socket
from visualscript.editor.core.views.cutline import CutLine
from visualscript.editor.core.views.edge import Edge, EdgeGraphics
from visualscript.editor.core.models.data_types import EXEC
...
class WorkspaceView(QGraphicsView):
    ...
    def edgeDragStart(self, item):
        # from visualscript.editor.core.models.edge import Edge
    ...
    def handleContextMenu(self, event, start_socket: Socket):
        if not start_socket.is_input and not isinstance(start_socket.data_type, int):
            from visualscript.editor.core.models.context_menu import ContextMenu
            from visualscript.editor.core.models.element_browsers.inherited_attribute_browser import InheritedAttibutesBrowser
