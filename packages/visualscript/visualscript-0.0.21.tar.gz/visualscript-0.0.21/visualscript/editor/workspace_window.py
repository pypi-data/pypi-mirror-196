...
from visualscript.editor.core.models.workspace import WorkspaceWidget
...
class WorkspaceWindow(WorkspaceWidget):
    ...
    def handleNewNodeContextMenu(self, event):
        ...
        from visualscript.editor.core.models.element_browsers.node_browser import NodeBrowser
