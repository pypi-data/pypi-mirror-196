    ...
    def test_auth_client_interacts_with_data_connect_service_with_no_auth(self):
        ...
        while True:
            ...
            try:
                ...
                self._logger.info(f'E/{client.endpoint.id}: This endpoint allows clients to list tables without '
                                  f'authentication. This is acceptable behaviour.')
                return  # Terminate the test here.
            except ServerError as e:
                if e.status in (401, 403):
                    self._logger.info(f'E/{client.endpoint.id}: This endpoint responds to an anonymous list-table '
