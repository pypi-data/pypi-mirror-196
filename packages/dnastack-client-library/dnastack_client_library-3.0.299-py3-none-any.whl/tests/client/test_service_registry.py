...
from tests.exam_helper import BaseTestCase, token_endpoint, device_code_endpoint

SERVICE_REGISTRY_URL = env('E2E_SERVICE_REGISTRY_URL',
                           required=False,
                           default=urljoin(BaseTestCase._context_base_url, '/api/service-registry/'))
...
REGISTERED_COLLECTION_SERVICE_URL = env('E2E_REGISTERED_COLLECTION_SERVICE_URL',
                                        required=False,
                                        default=urljoin(BaseTestCase._context_base_url, '/api/'))
...
class TestClientFactoryUnit(BaseTestCase):
    ...
    def test_all_service_infos(self):
        ...
        sample_json_response = json.dumps([
            {
                ...
                "url": urljoin(self._context_base_url, '/api/'),
                "authentication": [
                    {
                        ...
                        "resource": urljoin(self._context_base_url, '/'),
                        "scope": None,
                        "type": "oauth2"
                    }
                ]
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url, '/ga4gh/drs/v1/'),
                "authentication": [
                    {
                        "accessTokenUrl": token_endpoint,
                        "clientId": "explorer-public",
                        ...
                        "deviceCodeUrl": device_code_endpoint,
                        "grantType": "urn:ietf:params:oauth:grant-type:device_code",
                        "resource": urljoin(self._context_base_url, '/ga4gh/drs/'),
            ...
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url, '/api/collection/covid-19-in-ontario/data-connect/'),
                "authentication": [
                    {
                        "accessTokenUrl": token_endpoint,
                        "clientId": "explorer-public",
            ...
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url,
            ...
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url, '/api/collection/covid-19-tracker-canada/data-connect/'),
                "authentication": [
                    {
                        "accessTokenUrl": token_endpoint,
                        "clientId": "explorer-public",
            ...
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url, '/api/collection/pacbio-hifiviral-resources/data-connect/'),
                "authentication": [
                    {
                        "accessTokenUrl": token_endpoint,
                        "clientId": "explorer-public",
            ...
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url, '/api/collection/virusseq/data-connect/'),
                "authentication": [
                    {
                        "accessTokenUrl": token_endpoint,
                        "clientId": "explorer-public",
            ...
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url, '/api/collection/cdc-wastewater-surveillance/data-connect/'),
                "authentication": [
                    {
                        "accessTokenUrl": token_endpoint,
                        "clientId": "explorer-public",
            ...
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url, '/api/collection/covid-19-global-data-repository/data-connect/'),
                "authentication": [
                    {
                        "accessTokenUrl": token_endpoint,
                        "clientId": "explorer-public",
            ...
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url, '/api/collection/ncbi-sra/data-connect/'),
                "authentication": [
                    {
                        "accessTokenUrl": token_endpoint,
                        "clientId": "explorer-public",
            ...
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url, '/api/collection/us-hospital-statistics/data-connect/'),
                "authentication": [
                    {
                        "accessTokenUrl": token_endpoint,
                        "clientId": "explorer-public",
            ...
            },
            {
                ...
                "environment": None,
                "version": "1.0-1028-g9ffdd94",
                "url": urljoin(self._context_base_url, '/api/collection/covid-19-us-data-repository/data-connect/'),
                "authentication": [
                    {
                        "accessTokenUrl": token_endpoint,
                        "clientId": "explorer-public",
        ...
        self.assertEqual(f'{self._context_base_url} {urljoin(self._context_base_url, "/ga4gh/drs/")}',
