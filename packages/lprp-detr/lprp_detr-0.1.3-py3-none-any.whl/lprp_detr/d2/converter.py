...
def parse_args():
    parser = argparse.ArgumentParser("D2 detr converter")

    parser.add_argument("--source_model", default="", type=str, help="Path or url to the DETR detr to convert")
    parser.add_argument("--output_model", default="", type=str, help="Path where to save the converted detr")
...
def main():
    ...
    model_to_convert = checkpoint["detr"]
    ...
    model_to_save = {"detr": model_converted}
