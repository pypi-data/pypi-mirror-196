...
from lprp_detr.models.backbone import Backbone, Joiner
from lprp_detr.models.detr import DETR, PostProcess
from lprp_detr.models.position_encoding import PositionEmbeddingSine
from lprp_detr.models.segmentation import DETRsegm, PostProcessPanoptic
...
def detr_resnet50(pretrained=False, num_classes=91, return_postprocessor=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(checkpoint["detr"])
