...
from lprp_detr.models.position_encoding import PositionEmbeddingSine, PositionEmbeddingLearned
from lprp_detr.models.backbone import Backbone
from lprp_detr.util import box_ops
from lprp_detr.util.misc import nested_tensor_from_tensor_list
from lprp_detr.hubconf import detr_resnet50, detr_resnet50_panoptic
...
class ONNXExporterTester(unittest.TestCase):
    ...
    def run_model(self, model, inputs_list, tolerate_small_mismatch=False, do_constant_folding=True, dynamic_axes=None,
        ...
        # validate the exported detr with onnx runtime
    ...
    def test_model_onnx_detection(self):
        ...
        # Test exported detr on images of different size, or dummy input
        self.run_model(
            model,
