...
from lprp_detr.models.backbone import Joiner
from lprp_detr.models.detr import DETR, SetCriterion
from lprp_detr.models.matcher import HungarianMatcher
from lprp_detr.models.position_encoding import PositionEmbeddingSine
from lprp_detr.models.transformer import Transformer
from lprp_detr.models.segmentation import DETRsegm, PostProcessSegm
from lprp_detr.util.box_ops import box_cxcywh_to_xyxy, box_xyxy_to_cxcywh
from lprp_detr.util.misc import NestedTensor
from lprp_detr.datasets.coco import convert_coco_poly_to_mask
    ...
    def __init__(self, cfg):
        ...
        if self.mask_on:
            ...
            if frozen_weights != '':
                ...
                weight = torch.load(frozen_weights, map_location=lambda storage, loc: storage)['detr']
                new_weight = {}
                for k, v in weight.items():
                    if 'detr.' in k:
                        new_weight[k.replace('detr.', '')] = v
                    else:
                        print(f"Skipping loading weight {k} from frozen detr")
                del weight
    ...
    def forward(self, batched_inputs):
        ...
        Args:
            batched_inputs: a list, batched outputs of :class:`DatasetMapper` .
                ...
                * "height", "width" (int): the output resolution of the detr, used in inference.
