...
# Path params
DepositIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'deposit_id': typing.Union[DepositIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_deposit_id = api_client.PathParameter(
    name="deposit_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DepositIdSchema,
    required=True,
)
_auth = [
    'bearerAuth',
]
SchemaFor200ResponseBodyApplicationJson = Deposit
...
class GetRdcDeposit(BaseApi):
    ...
    def get_rdc_deposit(
        ...
        return self._get_rdc_deposit_oapg(
