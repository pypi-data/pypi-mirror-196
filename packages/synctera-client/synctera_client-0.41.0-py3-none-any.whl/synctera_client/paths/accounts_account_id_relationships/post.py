...
SchemaFor201ResponseBodyApplicationJson = Relationship
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_account_relationship_oapg(
        self,
...
class CreateAccountRelationship(BaseApi):
    ...
    def create_account_relationship(
        ...
        return self._create_account_relationship_oapg(
            body=body,
