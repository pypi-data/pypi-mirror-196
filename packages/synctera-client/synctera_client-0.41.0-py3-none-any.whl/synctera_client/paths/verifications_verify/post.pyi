...
# body param
SchemaForRequestBodyApplicationJson = VerificationRequest


request_body_verification_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = VerifyResponse
...
class BaseApi(api_client.Api):
    ...
    def _verify_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_verification_request.serialize(body, content_type)
