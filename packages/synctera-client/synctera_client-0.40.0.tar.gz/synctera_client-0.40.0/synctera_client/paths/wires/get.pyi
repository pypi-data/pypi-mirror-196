...
from synctera_client.model.direction import Direction
...
OriginatingAccountIdSchema = schemas.UUIDSchema
ReceivingAccountIdSchema = schemas.UUIDSchema
DirectionSchema = Direction
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'originating_account_id': typing.Union[OriginatingAccountIdSchema, str, uuid.UUID, ],
        'receiving_account_id': typing.Union[ReceivingAccountIdSchema, str, uuid.UUID, ],
...
request_query_receiving_account_id = api_client.QueryParameter(
    name="receiving_account_id",
    style=api_client.ParameterStyle.FORM,
    schema=ReceivingAccountIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = WireList
...
class BaseApi(api_client.Api):
    ...
    def _list_wires_oapg(
        ...
        for parameter in (
            ...
            request_query_receiving_account_id,
