...
class Wire(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            suspense_reason = schemas.StrSchema
            __annotations__ = {
                "amount": amount,
                ...
                "suspense_reason": suspense_reason,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suspense_reason"]) -> MetaOapg.properties.suspense_reason: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "creation_time", "currency", "customer_id", "effective_date", "id", "last_updated_time", "originating_account_id", "receiving_account_id", "sender_reference_id", "status", "transaction_id", "bank_message", "direction", "recipient_message", "suspense_reason", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suspense_reason"]) -> typing.Union[MetaOapg.properties.suspense_reason, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "creation_time", "currency", "customer_id", "effective_date", "id", "last_updated_time", "originating_account_id", "receiving_account_id", "sender_reference_id", "status", "transaction_id", "bank_message", "direction", "recipient_message", "suspense_reason", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        suspense_reason: typing.Union[MetaOapg.properties.suspense_reason, str, schemas.Unset] = schemas.unset,
