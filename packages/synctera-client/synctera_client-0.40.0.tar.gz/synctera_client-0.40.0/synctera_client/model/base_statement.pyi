...
class BaseStatement(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_summary", "authorized_signer", "closing_balance", "disclosure", "joint_account_holders", "opening_balance", "primary_account_holder_business", "primary_account_holder_personal", "transactions", "transactions_omitted", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_summary", "authorized_signer", "closing_balance", "disclosure", "joint_account_holders", "opening_balance", "primary_account_holder_business", "primary_account_holder_personal", "transactions", "transactions_omitted", ], str]):
