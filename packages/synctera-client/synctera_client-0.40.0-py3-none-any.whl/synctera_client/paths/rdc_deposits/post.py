...
# body param
SchemaForRequestBodyApplicationJson = Deposit


request_body_deposit = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Deposit
...
class BaseApi(api_client.Api):
    ...
    def _create_rdc_deposit_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_deposit.serialize(body, content_type)
...
class CreateRdcDeposit(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_rdc_deposit(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_rdc_deposit(
        ...
        return self._create_rdc_deposit_oapg(
            body=body,
