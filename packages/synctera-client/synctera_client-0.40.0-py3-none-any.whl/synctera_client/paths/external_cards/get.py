...
BusinessIdSchema = schemas.UUIDSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'business_id': typing.Union[BusinessIdSchema, str, uuid.UUID, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = ExternalCardListResponse
...
class ListExternalCards(BaseApi):
    ...
    def list_external_cards(
        ...
        return self._list_external_cards_oapg(
