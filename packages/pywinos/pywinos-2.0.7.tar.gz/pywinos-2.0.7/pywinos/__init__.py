...
class WinOSClient:
    ...
    def _set_protocol(self, endpoint: str, transport: str = 'ntlm'):
    ...
    def _client(self, use_cred_ssp: bool = False):
        ...
        client = self._set_protocol(endpoint=endpoint, transport=transport)

        self.logger.debug(f'The client has been created:\n\tEndpoint: {endpoint}\n\tTransport: {transport}')
        return client
    ...
    def exec_command(self, command: str, ps: bool = False, use_cred_ssp: bool = False, *args) -> WinResponse:
        ...
        client = self._client(use_cred_ssp=use_cred_ssp)
    ...
    def run_cmd(self, command: str, use_cred_ssp: bool = False, *args) -> WinResponse:
        ...
        return self.exec_command(command, ps=False, use_cred_ssp=use_cred_ssp, *args)

    def run_ps(self, command: str, use_cred_ssp: bool = False) -> WinResponse:
