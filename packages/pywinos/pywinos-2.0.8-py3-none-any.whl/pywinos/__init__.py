...
class WinOSClient:
    ...
    def exec_command(self, command: str, ps: bool = False,
                     use_cred_ssp: bool = False, insecure: bool = False, *args) -> WinResponse:
    ...
    def run_cmd(self, command: str, use_cred_ssp: bool = False, insecure: bool = False, *args) -> WinResponse:
        """Allows executing cmd command on a remote server.

        :param command: Command to execute using cmd.exe
        :param use_cred_ssp:
        :param insecure: Insecure! http://{IP}:5985/wsman will be used!
        ...
        return self.exec_command(command, ps=False, use_cred_ssp=use_cred_ssp, insecure=insecure, *args)

    def run_ps(self, command: str, use_cred_ssp: bool = False, insecure: bool = False) -> WinResponse:
        """Allows executing PowerShell command or script using a remote shell.

        :param command: Command to execute using PoserShell
        :param use_cred_ssp:
        :param insecure: Insecure! http://{IP}:5985/wsman will be used!
        :return: WinResponse class
        """

        return self.exec_command(command, ps=True, use_cred_ssp=use_cred_ssp, insecure=insecure)
