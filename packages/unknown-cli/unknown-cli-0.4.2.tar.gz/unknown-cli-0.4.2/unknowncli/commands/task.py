...
## p4 copy -Af -S //Project/jonb-2023-03-03-plugin_functional_tests //Project/SN2-Main/...
    ...
    try:
        p4.run_copy("-Af", "-S", stream_name, ret["baseParent"] + "/...")
    except P4Exception as e:
    ...
    secho(f"You can now submit your changelist to {parent} in p4v")
    # TODO: Something
    #echo(f"Switching to task stream {stream_name}...")
    #p4.run_client("-s", "-S", stream_name)
