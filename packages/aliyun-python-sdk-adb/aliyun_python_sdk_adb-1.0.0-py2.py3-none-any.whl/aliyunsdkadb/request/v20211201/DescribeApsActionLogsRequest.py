...
class DescribeApsActionLogsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'adb', '2021-12-01', 'DescribeApsActionLogs','ads')
	...
	def get_Stage(self): # String
		return self.get_query_params().get('Stage')

	def set_Stage(self, Stage):  # String
	...
	def get_WorkloadId(self): # String
		return self.get_query_params().get('WorkloadId')

	def set_WorkloadId(self, WorkloadId):  # String
		self.add_query_param('WorkloadId', WorkloadId)
