...
class SCC(Algorithm):
    ...
    def user_input(self):
        ...
        if self.default_mode:
            ...
            self.algo_params["weight_feat"] = float(
                input(f"Weight for feature-feature correlation: {self.default_vals['weight_feat']}") or
                self.default_vals['weight_feat'])
            self.algo_params["weight_class"] = float(
                input(f"Weight for feature-class correlation: {self.default_vals['weight_class']}") or
    ...
    def execute(self):
        ...
        self.scores = (self.algo_params["weight_class"] * self.feature_class_relation) + (
