    ...
    def load_file(scheme, path, params):
        try:
            ...
            raise RuntimeError(
                ...
                ' - Also requied: `brew install snappy` (mac) or `sudo apt-get install libsnappy-dev` (ubuntu)\n'
                '(See also, additional install errors troubleshooting guide: https://github.com/andrix/python-snappy#frequently-asked-questions)'
            ) from exc
