...
class PlatformJson(pydantic.BaseModel):
    ...
    def __setattr__(self, name, value):
        ...
        logger.info("Updated %s.%s = %s", self.path.name, name, value)
    ...
    files: Dict[str, Dict[str, Dict[str, List]]] = pydantic.Field(default_factory=dict)
    ...
    def update(self, field, new) -> None:
        ...
        print('Updating %s %s: %s -> %s', self.path.name, field, existing, new)
    ...
    with pj.sync_disabled():
        ...
        if pj.script_name:
            with contextlib.suppress(Exception):
                pj.update('script_name', np_config.local_to_unc(session.rig.stim, pj.script_name))
...
if __name__ == '__main__':
    ...
    pj = PlatformJson(path=R'\\allen\programs\mindscope\workgroups\np-exp\habituation\1252811121_661730_20230309')
    pj.hab = True
    pj.manipulator_coordinates = {'brain_surface_image': {'A': {'x': 3076.0, 'y': 3701.5, 'z': 392.5}, 'B': {'x': 4480.0, 'y': 2767.5, 'z': 200.5}, 'C': {'x': 3222.5, 'y': 4172.0, 'z': -0.5}, 'D': {'x': 3677.0, 'y': 2035.5, 'z': 0.5}, 'E': {'x': 3690.0, 'y': 2838.5, 'z': 0.5}, 'F': {'x': 4862.5, 'y': 2559.5, 'z': 0.5}}}
    # pj.manipulator_coordinates = {'test_surface_image': {'A': {'x': 3076.0, 'y': 3701.5, 'z': 392.5}, 'B': {'x': 4480.0, 'y': 2767.5, 'z': 200.5}, 'C': {'x': 3222.5, 'y': 4172.0, 'z': -0.5}, 'D': {'x': 3677.0, 'y': 2035.5, 'z': 0.5}, 'E': {'x': 3690.0, 'y': 2838.5, 'z': 0.5}, 'F': {'x': 4862.5, 'y': 2559.5, 'z': 0.5}}}
    # pj.update('manipulator_coordinates', {'test_surface_image': {'A': {'x': 3076.0, 'y': 3701.5, 'z': 392.5}, 'B': {'x': 4480.0, 'y': 2767.5, 'z': 200.5}, 'C': {'x': 3222.5, 'y': 4172.0, 'z': -0.5}, 'D': {'x': 3677.0, 'y': 2035.5, 'z': 0.5}, 'E': {'x': 3690.0, 'y': 2838.5, 'z': 0.5}, 'F': {'x': 4862.5, 'y': 2559.5, 'z': 0.5}}})
    # pj.manipulator_coordinates = np_config.merge(copy.deepcopy(pj.manipulator_coordinates), {'test_surface_image': {'A': {'x': 3076.0, 'y': 3701.5, 'z': 392.5}, 'B': {'x': 4480.0, 'y': 2767.5, 'z': 200.5}, 'C': {'x': 3222.5, 'y': 4172.0, 'z': -0.5}, 'D': {'x': 3677.0, 'y': 2035.5, 'z': 0.5}, 'E': {'x': 3690.0, 'y': 2838.5, 'z': 0.5}, 'F': {'x': 4862.5, 'y': 2559.5, 'z': 0.5}}})