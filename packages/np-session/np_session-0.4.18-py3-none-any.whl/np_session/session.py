...
class Session:
    ...
    def platform_json(self) -> PlatformJson:
        ...
        Not cached so we always get the current contents on disk.
        """
        platform_json = PlatformJson(self.npexp_path)
        update_from_session(platform_json, self)
...
def latest_session(str | Projects):
