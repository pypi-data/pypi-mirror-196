...
class Table_of_contents_schema(Pt_schema):
    ...
    def set_tables(self):
        self.ingest_tables = {'toc_header': Toc_header(self._spark),
                              'toc_reporting': Toc_reporting(self._spark)}
        self.analytic_tables = {'index_reports': Index_reports(self._spark)}
