...
def add_default_arg_building_arguments(parser):
    ...
    # Hashing parameters
    parser.add_argument("--sequence_hash_cm", action="store", default=0.1, type=float,
        help="Sequence mode hashing window size in cM (default=0.1)")
...
def build_arg_simulation(args, simulation, base_tmp_dir, snp_indices=None,
    ...
    if mode == "array":
        ...
        if use_asmc_clust:
            ...
            arg = upgma_chunk(pairwise_decoder, num_snp_samples, simulation.sequence_length,
