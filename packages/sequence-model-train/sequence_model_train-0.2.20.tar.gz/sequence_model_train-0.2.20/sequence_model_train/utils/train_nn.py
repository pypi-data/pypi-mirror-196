...
class TrainNNModel:
    def __init__(self, params, model_type):
        ...
        self.model_params = {
            'features_size': params['input_size'],
    ...
    def fit(self, X, y):
        params = {
            'input_size': self.model_params['features_size'],
        ...
        if self.model_type == 'tcn':
            num_channels = [params['features_size']] + [params['hidden_size'] for i in range(params['num_layers']-1)]
            model = TCN(input_size=params['features_size'],
                        output_size=params['n_out'],
