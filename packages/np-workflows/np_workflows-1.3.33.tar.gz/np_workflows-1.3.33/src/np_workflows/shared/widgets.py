...
def wheel_height_widget(platform_json: pathlib.Path | np_session.PlatformJson) -> IPython.display.DisplayHandle | None:
    ...
    if isinstance(platform_json, pathlib.Path):
        platform_json = np_session.PlatformJson(path=platform_json)
...
def di_widget(platform_json: pathlib.Path | np_session.PlatformJson) -> IPython.display.DisplayHandle | None:
