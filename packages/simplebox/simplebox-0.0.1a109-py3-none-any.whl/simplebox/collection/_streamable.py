...
from typing import Iterable, Callable, List, Dict, Type
...
class Streamable(Iterable[T], ABC):
    ...
    def distinct(self) -> 'Streamable[T]':
        """
        Returns a stream consisting of the distinct elements (according to set(object)) of this stream.
        """
    ...
    @abstractmethod
    def intersection(self, iterable: Iterable[T]) -> 'Streamable[T]':
        """
        Output intersection
    ...
    @abstractmethod
    def union(self, iterable: Iterable[T]) -> 'Streamable[T]':
        """
        Output union
        If it is a custom object, you need to override __eq__ and __hash__
    ...
    @abstractmethod
    def difference(self, iterable: Iterable[T]) -> 'Streamable[T]':
        """
        Output difference
        If it is a custom object, you need to override __eq__ and __hash__
    ...
    @abstractmethod
    def symmetric_difference(self, iterable: Iterable[T]) -> 'Streamable[T]':
        """
    ...
    @abstractmethod
    def collect(self, collector: Type[Iterable[T]]) -> Iterable[T]:
        """
    ...
    @abstractmethod
    def partition(self, size: int = 1, collector: Type[Iterable] = list) -> 'List[Iterable[T]]':
        """
