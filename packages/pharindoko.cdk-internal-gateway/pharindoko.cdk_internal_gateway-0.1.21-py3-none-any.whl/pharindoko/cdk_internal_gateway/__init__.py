...
class InternalService(
    ...
    def __init__(
        ...
        *,
        ...
        :param custom_domain_ssl_policy: (experimental) SSLPolicy attached to the apigateway custom domain. Default: apigateway.SslPolicy.TLS_1_2
        :param load_balancer_listener_ssl_policy: (experimental) SSLPolicy attached to the load balancer listener. Default: elb.SslPolicy.FORWARD_SECRECY_TLS12_RES_GCM
...
class InternalServiceProps:
    ...
    def custom_domain_ssl_policy(
        ...
        '''(experimental) SSLPolicy attached to the apigateway custom domain.
    ...
    def load_balancer_listener_ssl_policy(
        ...
        '''(experimental) SSLPolicy attached to the load balancer listener.
