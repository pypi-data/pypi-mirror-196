...
def ragged_fill_empty_rows(value_rowids, values, nrows, default_value, name=None):
  r"""TODO: add doc.
...
def ragged_fill_empty_rows_eager_fallback(value_rowids, values, nrows, default_value, name, ctx):
...
def ragged_fill_empty_rows_grad(reverse_index_map, grad_values, name=None):
  r"""TODO: add doc.
...
def ragged_fill_empty_rows_grad_eager_fallback(reverse_index_map, grad_values, name, ctx):
