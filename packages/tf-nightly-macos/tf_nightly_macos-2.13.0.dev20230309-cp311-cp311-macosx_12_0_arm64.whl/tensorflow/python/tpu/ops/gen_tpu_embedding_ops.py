...
def merge_dedup_data(integer_tensor, float_tensor, tuple_mask, config="", name=None):
  r"""TODO: add doc.
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        ...
        "tuple_mask", tuple_mask, "config", config)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
    ...
    try:
      _result = _dispatcher_for_merge_dedup_data(
          (integer_tensor, float_tensor, tuple_mask, config, name,), None)
      if _result is not NotImplemented:
        return _result
      return merge_dedup_data_eager_fallback(
          integer_tensor, float_tensor, tuple_mask=tuple_mask, config=config,
          name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
    except (TypeError, ValueError):
  ...
  if _execute.must_record_gradient():
    _attrs = ("tuple_mask", _op.get_attr("tuple_mask"), "integer_type",
              ...
              _op._get_attr_type("float_type"), "config",
              _op.get_attr("config"))
    _inputs_flat = _op.inputs
    _execute.record_gradient(
...
def merge_dedup_data_eager_fallback(integer_tensor, float_tensor, tuple_mask, config, name, ctx):
  tuple_mask = _execute.make_str(tuple_mask, "tuple_mask")
  if config is None:
    config = ""
  config = _execute.make_str(config, "config")
  ...
  "float_type", _attr_float_type, "config", config)
...
def split_dedup_data(input, integer_type, float_type, tuple_mask, config="", name=None):
  r"""TODO: add doc.
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        ...
        "float_type", float_type, "tuple_mask", tuple_mask, "config", config)
    ...
    try:
      _result = _dispatcher_for_split_dedup_data(
          (input, integer_type, float_type, tuple_mask, config, name,), None)
      if _result is not NotImplemented:
        return _result
      return split_dedup_data_eager_fallback(
          input, integer_type=integer_type, float_type=float_type,
          tuple_mask=tuple_mask, config=config, name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
    except (TypeError, ValueError):
      _result = _dispatch.dispatch(
  ...
  if _execute.must_record_gradient():
    _attrs = ("integer_type", _op._get_attr_type("integer_type"),
              ...
              _op.get_attr("tuple_mask"), "config", _op.get_attr("config"))
    _inputs_flat = _op.inputs
    _execute.record_gradient(
...
def split_dedup_data_eager_fallback(input, integer_type, float_type, tuple_mask, config, name, ctx):
  integer_type = _execute.make_type(integer_type, "integer_type")
  float_type = _execute.make_type(float_type, "float_type")
  tuple_mask = _execute.make_str(tuple_mask, "tuple_mask")
  if config is None:
