...
class OcrLayoutAnalysisController(OcrStandardController):
    def __init__(self, check_result, service_path,image_pkg_path=""):
        super(OcrLayoutAnalysisController, self).__init__(check_result, service_path)
        self.tf_name = "ocr-layout-analysis"
