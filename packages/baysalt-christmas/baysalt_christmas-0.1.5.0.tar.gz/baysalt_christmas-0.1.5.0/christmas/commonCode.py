...
class SftpProcessbar(object):
    """
    ftp_obj = SftpTest('47.105.220.136', 22, 'wave', 'wave', '/home/ocean/x.zip', '/home/wave/x.zip')
    ftp_obj.sftpupload()
    ...
    def call_back(self, curr=100, total=100):
        ...
        print(
            f'translating: [{bar}] {percents}% already complete: {self.translate_byte(curr)}, total: {self.translate_byte(total)}\r',
            end='',
        )
