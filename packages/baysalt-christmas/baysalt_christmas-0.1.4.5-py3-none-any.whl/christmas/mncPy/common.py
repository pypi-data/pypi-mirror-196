...
class GlobalData(object,):
    ...
    def read_datetime_info(self, filePaths, time_str, time_bound_str, comm):
        ...
        comm.Reduce([tbounds0_local, PYMPI.INT],[tbounds0_global, PYMPI.INT], op=PYMPI.MAX, root=0)
        comm.Reduce([tbounds1_local, PYMPI.INT],[tbounds1_global, PYMPI.INT], op=PYMPI.MAX, root=0)
...
def get_file_paths(fpaths_in, args_x, args_v):
