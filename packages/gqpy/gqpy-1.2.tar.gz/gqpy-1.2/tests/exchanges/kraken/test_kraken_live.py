...
class TestKrakenLive(unittest.TestCase):
    ...
    def test_ticker(self):
        ...
        self.assertEqual(dp['channel'], 'kraken.spot.ticker.XBT/USD')
    ...
    def test_book(self):
        ...
        self.assertEqual(dict, type(dp))
        self.assertEqual(dp['assetClass'], 'spot')
        self.assertEqual(dp['channel'], 'kraken.spot.book.XBT/USD')
    ...
    def test_trade(self):
        ...
        self.assertEqual(dict, type(dp))
        self.assertEqual(dp['assetClass'], 'spot')
        self.assertEqual(dp['channel'], 'kraken.spot.trade.XBT/USD')
