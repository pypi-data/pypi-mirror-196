...
class DriftEvaluation(AIOSBaseJob):
        ...
        if len(first_row):
            if not drift_database or not drift_table:
                ...
                DbUtils.write_dataframe_to_table(
                    ...
                    connection_properties=self.jdbc_connection_properties_map.get("drift"),
    ...
    def __validate_tables_schema(self):
        ...
        for table in tables_to_be_validated:
            ...
            columns = DbUtils.list_columns(
                ...
                connection_properties=self.jdbc_connection_properties_map.get(get(table, "type")),
    ...
    def __get_payload_spark_df(self):
        ...
        spark_df = DbUtils.get_table_as_dataframe(
            ...
            connection_properties=self.jdbc_connection_properties_map.get("payload"),
