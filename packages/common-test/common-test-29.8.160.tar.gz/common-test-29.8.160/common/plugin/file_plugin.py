...
class FilePlugin(object):
    @classmethod
    def excel_to_dict(self, file_name, sheet: str='Sheet1', _replace: bool=True, file_path: str=TEST_DATA_PATH, _filter:dict=None):
        """
        ...
        return excel_to_list(path.join(file_path, file_name), sheet, _filter, _replace)
