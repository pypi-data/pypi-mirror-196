...
HONEYCOMB_PREAMBLE = 'import jsPsychHtmlKeyboardResponse from \'@jspsych/plugin-html-keyboard-response\'\n' \
                     'import jsPsychSurveyText from \'@jspsych/plugin-survey-text\'\n' \
                     'import jsPsychSurveyMultiChoice from \'@jspsych/plugin-survey-multi-choice@1.1.2\'\n' \
                     'import jsPsychSurveyLikert from \'@jspsych/plugin-survey-likert@1.1.2\'\n' \
