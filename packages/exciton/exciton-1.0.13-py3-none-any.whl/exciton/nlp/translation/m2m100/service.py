...
from .utils import support_languages
...
class M2M100(object):
    ...
    def __init__(
        ...
        MODEL_DIR = "exciton/models/nlp"
        self.translator = ctranslate2.Translator(
            f"{HOME}/{MODEL_DIR}/translation/m2m100/{model}", device=device
        )
        self.tokenizer = transformers.AutoTokenizer.from_pretrained(
            f"{HOME}/{MODEL_DIR}/translation/m2m100/{model}/tokenizer/"
        )
    ...
    def get_support_languages(self) -> List[Dict[str, str]]:
        ...
        """
        return [{"code": wd, "name": support_languages[wd]} for wd in support_languages]
    ...
    def predict(self, source: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for batch in self._batch(source):
            ...
            for itm in batch:
                ...
                if slang in support_languages and tlang in support_languages:
