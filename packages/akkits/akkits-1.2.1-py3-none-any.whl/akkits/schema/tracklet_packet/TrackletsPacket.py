...
def AddCount(builder, count):
    builder.PrependUint16Slot(1, count, 0)
...
def AddLidartsMs(builder, lidartsMs):
    builder.PrependFloat64Slot(2, lidartsMs, 0.0)
...
def AddUnixtsMs(builder, unixtsMs):
    builder.PrependFloat64Slot(3, unixtsMs, 0.0)
...
def AddTracklets(builder, tracklets):
    builder.PrependUOffsetTRelativeSlot(
        4, flatbuffers.number_types.UOffsetTFlags.py_type(tracklets), 0
    )
...
def StartTrackletsVector(builder, numElems):
