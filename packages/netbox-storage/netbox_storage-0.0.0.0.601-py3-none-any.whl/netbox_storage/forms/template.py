...
# /boot/efi --fstype="efi" --ondisk=sda --size=126 --fsoptions="umask=0077,shortname=winnt" --label=boot_efi
    ...
    def save(self, *args, **kwargs):
        ...
        MountedVolume.objects.create(device=linux_device, mount_point=self.cleaned_data['mount_point'],
                                     fs_type=self.cleaned_data['fs_type'], options=self.cleaned_data['fs_options'])
