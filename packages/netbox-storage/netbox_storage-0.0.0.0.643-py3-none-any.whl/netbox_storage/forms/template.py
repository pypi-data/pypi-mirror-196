...
class LVMTemplateForm(NetBoxModelForm):
    ...
    def save(self, *args, **kwargs):
        ...
        partition = Partition.objects.create(drive=self.cleaned_data['drive'], device=linux_device, size=self.cleaned_data['size'], type='Linux LVM')
        ...
        linux_device_mapper = LinuxDevice.objects.create(device='/dev/mapper/vg_system-lv_home', type=self.cleaned_data['fs_type'])
