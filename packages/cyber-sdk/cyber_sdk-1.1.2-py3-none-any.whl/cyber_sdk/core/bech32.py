...
AccAddress.__doc__ = """Bostrom Bech32 Account Address -- type alias of str."""

ValAddress = NewType("ValAddress", str)
ValAddress.__doc__ = """Bostrom Bech32 Validator Operator Address -- type alias of str."""

AccPubKey = NewType("AccPubKey", str)
AccPubKey.__doc__ = """Bostrom Bech32 Account Address -- type alias of str."""

ValPubKey = NewType("ValPubKey", str)
ValPubKey.__doc__ = """Bostrom Bech32 Validator PubKey -- type alias of str."""

# ValConsPubKey = NewType("ValConsPubKey", str)
# ValConsPubKey.__doc__ = (
#  """Bostrom Bech32 Validator Conensus PubKey -- type alias of str."""
# )


def is_acc_address(data: str) -> bool:
    """Checks whether the given string is a properly formatted Bostrom account address.
    ...
    """
    return check_prefix_and_length("bostrom", data, 44)
...
def to_acc_address(data: ValAddress) -> AccAddress:
    ...
    return AccAddress(bech32_encode("bostrom", vals[1]))


def is_val_address(data: str) -> bool:
    """Checks whether the given string is a properly formatted Bostrom validator operator
    address.
    ...
    """
    return check_prefix_and_length("bostromvaloper", data, 51)
...
def to_val_address(data: AccAddress) -> ValAddress:
    ...
    if vals[1] is None:
        raise ValueError(f"invalid bech32: {data}")
    return ValAddress(bech32_encode("bostromvaloper", vals[1]))


def is_acc_pubkey(data: str) -> bool:
    """Checks whether the provided string is a properly formatted Bostrom account pubkey.
    ...
    """
    return check_prefix_and_length("bostrompub", data, 76)
...
def to_acc_pubkey(data: ValPubKey) -> AccPubKey:
    ...
    if vals[1] is None:
        raise ValueError(f"invalid bech32: {data}")
    return AccPubKey(bech32_encode("bostrompub", vals[1]))


def is_val_pubkey(data: str) -> bool:
    """Checks whether provided string is a properly formatted Bostrom validator pubkey.
    ...
    """
    return check_prefix_and_length("bostromvaloperpub", data, 83)
...
def to_val_pubkey(data: AccPubKey) -> ValPubKey:
    ...
    if vals[1] is None:
        raise ValueError(f"invalid bech32: {data}")
    return ValPubKey(bech32_encode("bostromvaloperpub", vals[1]))


def is_valcons_pubkey(data: str) -> bool:  # -> ValConsPubKey:
    """Checks whether provided string is a properly formatted Bostrom validator consensus
    pubkey.
    ...
    """
    return check_prefix_and_length("bostromvalconspub", data, 83)
