...
from cyber_proto.cosmos.crypto.ed25519 import PubKey as ValConsPubKey_pb
from cyber_proto.cosmos.crypto.multisig import LegacyAminoPubKey as LegacyAminoPubKey_pb
from cyber_proto.cosmos.crypto.secp256k1 import PubKey as SimplePubKey_pb
...
class SimplePublicKey(PublicKey):
    ...
    def address(self) -> str:
        return get_bech("bostrom", self.raw_address())
...
class ValConsPubKey(PublicKey):
    ...
    def address(self) -> str:
        return get_bech("bostromvalcons", self.raw_address())
...
class LegacyAminoMultisigPublicKey(PublicKey):
    ...
    def address(self) -> str:
        address = get_bech("bostrom", self.raw_address())
        return address

    def pubkey_address(self) -> str:
        return get_bech("bostrompub", str(self.encode_amino_pubkey()))
