...
from cyber_proto.cosmos.staking.v1beta1 import BondStatus
from cyber_proto.cosmos.staking.v1beta1 import Commission as Commission_pb
from cyber_proto.cosmos.staking.v1beta1 import CommissionRates as CommissionRates_pb
from cyber_proto.cosmos.staking.v1beta1 import Description as Description_pb
from cyber_proto.cosmos.staking.v1beta1 import Validator as Validator_pb

from cyber_sdk.core import Dec, ValAddress, ValConsPubKey
...
class Description(JSONSerializable):
    ...
    Args:
        moniker: validator name, aka: \"Bostromn One\"
