...
from cyber_proto.cosmos.staking.v1beta1 import MsgDelegate as MsgDelegate_pb
from cyber_proto.cosmos.staking.v1beta1 import MsgEditValidator as MsgEditValidator_pb
from cyber_proto.cosmos.staking.v1beta1 import MsgUndelegate as MsgUndelegate_pb

from cyber_sdk.core import AccAddress, Coin, Dec, ValAddress, ValConsPubKey
...
class MsgCreateValidator(Msg):
    """Register a new validator with the Bostrom protocol.
