...
import attr
from cyber_proto.terra.oracle.v1beta1 import (
...
from cyber_sdk.core import AccAddress, Coins, Dec, ValAddress
...
class MsgDelegateFeedConsent(Msg):
    ...
    """"""
    type_url = "/bostrom.oracle.v1beta1.MsgDelegateFeedConsent"
    """"""
...
class MsgAggregateExchangeRatePrevote(Msg):
    ...
    """"""
    type_url = "/bostrom.oracle.v1beta1.MsgAggregateExchangeRatePrevote"
    """"""
...
class MsgAggregateExchangeRateVote(Msg):
    ...
    """"""
    type_url = "/bostrom.oracle.v1beta1.MsgAggregateExchangeRateVote"
    """"""
