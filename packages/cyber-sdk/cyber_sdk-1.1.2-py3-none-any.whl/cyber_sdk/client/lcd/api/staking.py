...
from cyber_sdk.core import AccAddress, Coin, Numeric, ValAddress
...
class AsyncStakingAPI(BaseAsyncAPI):
    ...
    async def pool(self) -> StakingPool:
        ...
        res = res.get("pool")
        return StakingPool(
            bonded_tokens=Coin("boot", res["bonded_tokens"]),
            not_bonded_tokens=Coin("boot", res["not_bonded_tokens"]),
        )
