...
from cyber_sdk.core.bech32 import get_bech
from cyber_sdk.core.public_key import (
    PublicKey,
    address_from_public_key,
    amino_pubkey_from_public_key,
)
from cyber_sdk.core.signature_v2 import Descriptor
from cyber_sdk.core.signature_v2 import Single as SingleDescriptor
from cyber_sdk.core.tx import AuthInfo, SignerInfo, SignMode, Tx
...
class Key:
    ...
    def acc_address(self) -> AccAddress:
        """Bostrom Bech32 account address. Default derivation via :data:`public_key` is provided.
    ...
    def val_address(self) -> ValAddress:
        """Bostrom Bech32 validator operator address. Default derivation via :data:`public_key` is provided.
    ...
    def acc_pubkey(self) -> AccPubKey:
        """Bostrom Bech32 account pubkey. Default derivation via :data:`public_key` is provided.
    ...
    def val_pubkey(self) -> ValPubKey:
        """Bostrom Bech32 validator pubkey. Default derivation via ``public_key`` is provided.
