...
from cyber_proto.cosmos.authz.v1beta1 import (
    GenericAuthorization as GenericAuthorization_pb,
)
from cyber_proto.cosmos.authz.v1beta1 import Grant as Grant_pb
from cyber_proto.cosmos.bank.v1beta1 import SendAuthorization as SendAuthorization_pb
from cyber_proto.cosmos.staking.v1beta1 import AuthorizationType
from cyber_proto.cosmos.staking.v1beta1 import (
...
from cyber_sdk.core import AccAddress, Coin, Coins
...
class Authorization(BaseBostromData):
    """Base class for authorization types."""

    @staticmethod
    def from_data(data: dict) -> Authorization:
        from cyber_sdk.util.parse_authorization import parse_authorization
...
class SendAuthorization(Authorization):
    """Type of :class:`Authorization` for :class:`MsgSend<cyber_sdk.core.bank.msgs.MsgSend>`,
