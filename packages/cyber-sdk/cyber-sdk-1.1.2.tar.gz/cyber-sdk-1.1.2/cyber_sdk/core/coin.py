...
import attr
from cyber_proto.cosmos.base.v1beta1 import Coin as Coin_pb
...
class Coin(JSONSerializable):
    ...
    in Cosmos SDK. Used for representing Bostrom native assets.
    """

    denom: str = attr.ib()
    """Coin's denomination, ex ``uusd``, ``boot``, etc."""
    ...
    def from_str(cls, string: str) -> Coin:
        ...
        >>> int_coin.amount
        230920
        >>> dec_coin = Coin.from_str("203922.223boot")
        >>> dec_coin.denom
        'boot'
        >>> dec_coin.amount
        Dec('203922.223')
