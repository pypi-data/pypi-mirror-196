...
import attr
from cyber_proto.cosmos.gov.v1beta1 import MsgDeposit as MsgDeposit_pb
from cyber_proto.cosmos.gov.v1beta1 import MsgSubmitProposal as MsgSubmitProposal_pb
from cyber_proto.cosmos.gov.v1beta1 import MsgVote as MsgVote_pb
...
class MsgSubmitProposal(Msg):
    ...
    def from_data(cls, data: dict) -> MsgSubmitProposal:
        from cyber_sdk.util.parse_content import parse_content
