...
import attr
from cyber_proto.terra.vesting.v1beta1 import (
    LazyGradedVestingAccount as LazyGradedVestingAccount_pb,
)
from cyber_proto.terra.vesting.v1beta1 import Schedule as Schedule_pb
from cyber_proto.terra.vesting.v1beta1 import VestingSchedule as VestingSchedule_pb

from cyber_sdk.core import Dec
...
class LazyGradedVestingAccount(BaseAccount):
    ...
    type_url = "/bostrom.vesting.v1beta1.LazyGradedVestingAccount"
