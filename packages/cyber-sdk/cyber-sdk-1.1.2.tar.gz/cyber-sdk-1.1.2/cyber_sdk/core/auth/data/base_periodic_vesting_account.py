...
import attr
from cyber_proto.cosmos.auth.v1beta1 import BaseAccount as BaseAccount_pb

from ....core import AccAddress
from ....util.json import JSONSerializable
from ...public_key import PublicKey

__all__ = ["BasePeriodicVestingAccount"]


@attr.s
class BasePeriodicVestingAccount(JSONSerializable):
    """Stores information about an account."""

    type_amino = "core/Account"
    type_url = "/cosmos.auth.v1beta1.BasePeriodicVestingAccount"
    ...
    @classmethod
    def from_amino(cls, amino: dict) -> BasePeriodicVestingAccount:
        amino = amino["value"]
        return cls(
    ...
    @classmethod
    def from_proto(cls, proto: BaseAccount_pb) -> BasePeriodicVestingAccount:
        return cls(
