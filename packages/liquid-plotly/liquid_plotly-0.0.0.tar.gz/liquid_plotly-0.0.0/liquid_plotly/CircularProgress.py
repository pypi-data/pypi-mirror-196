...
- ariaValueMax (string; optional):
    Aria value max.

- ariaValueMin (string; optional):
    Aria value min.

- ariaValueNow (string; optional):
    Aria value now.

- ariaValuemax (number; optional):
...
- ariaValuemin (number; optional):
    Set to a decimal value representing the minimum value, and less
    than aria-valuemax. If not present, the default value is 0.

- ariaValuenow (number; optional):
    Only present and required if the value is not indeterminate. Set
    to a decimal value between 0, or valuemin if present, and
    aria-valuemax indicating the current value of the progress bar.

- ariaValuetext (string; optional):
    Assistive technologies often present the value of aria-valuenow as
    a percentage. If this would not be accurate use this property to
    make the progress bar value understandable.

- brandColor (boolean; optional):
    Styles the progress bar in a way that it looks good on the primary
...
- style (dict; optional):
    ...
    - motionRotation (boolean | number | string | dict | list; optional):
        ...
        | Firefox | Safari | Edge | IE  | | :--------------------: |
        :-----: | :----: | :--: | :-: | |         **56**         |
        **72**  |   No   | n/a  | No  | | 46 _(motion-rotation)_ |
        |        |      |     |
    ...
    _namespace = 'liquid_plotly'
    _type = 'CircularProgress'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, ariaLabeledBy=Component.UNDEFINED, ariaValueMax=Component.UNDEFINED, ariaValueMin=Component.UNDEFINED, ariaValueNow=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, ariaLabeledby=Component.UNDEFINED, ariaValuemax=Component.UNDEFINED, ariaValuemin=Component.UNDEFINED, ariaValuenow=Component.UNDEFINED, ariaValuetext=Component.UNDEFINED, brandColor=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'ariaLabeledBy', 'ariaLabeledby', 'ariaValueMax', 'ariaValueMin', 'ariaValueNow', 'ariaValuemax', 'ariaValuemin', 'ariaValuenow', 'ariaValuetext', 'brandColor', 'className', 'key', 'ref', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'ariaLabeledBy', 'ariaLabeledby', 'ariaValueMax', 'ariaValueMin', 'ariaValueNow', 'ariaValuemax', 'ariaValuemin', 'ariaValuenow', 'ariaValuetext', 'brandColor', 'className', 'key', 'ref', 'slot', 'style']
        ...
        super(CircularProgress, self).__init__(children=children, **args)
