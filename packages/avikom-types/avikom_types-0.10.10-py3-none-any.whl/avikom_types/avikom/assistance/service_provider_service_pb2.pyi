...
class ServiceRequest(google.protobuf.message.Message):
    ...
    @property
    def configuration(self) -> avikom_types.avikom.assistance.service_configuration_pb2.ServiceConfiguration:
    ...
    def __init__(
        ...
        *,
        task_id: builtins.str = ...,
        configuration: avikom_types.avikom.assistance.service_configuration_pb2.ServiceConfiguration | None = ...,
