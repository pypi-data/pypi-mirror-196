...
class RuntimeStepList(google.protobuf.message.Message):
    ...
    @property
    def steps(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[avikom_types.avikom.assistance.runtime_task_step_pb2.RuntimeTaskStep]:
    ...
    def __init__(
        self,
        *,
        steps: collections.abc.Iterable[avikom_types.avikom.assistance.runtime_task_step_pb2.RuntimeTaskStep] | None = ...,
