...
import avikom_types.avikom.unity.transpose_pb2
import builtins
...
class InstructionMeta(google.protobuf.message.Message):
    ...
    assistance_level: avikom_types.avikom.assistance.assistance_level_pb2.AssistanceLevel.ValueType
    """/ the targeted assistance level, this instruction wont be available for users with less assistance requirements"""
    @property
    def modal_bias(self) -> avikom_types.avikom.generic.modality_pb2.Modality:
    ...
    @property
    def transpose(self) -> avikom_types.avikom.unity.transpose_pb2.Transpose:
    ...
    def __init__(
        ...
        *,
        assistance_level: avikom_types.avikom.assistance.assistance_level_pb2.AssistanceLevel.ValueType = ...,
        modal_bias: avikom_types.avikom.generic.modality_pb2.Modality | None = ...,
        location: builtins.str = ...,
        transpose: avikom_types.avikom.unity.transpose_pb2.Transpose | None = ...,
        id: builtins.str = ...,
    ) -> None: ...
