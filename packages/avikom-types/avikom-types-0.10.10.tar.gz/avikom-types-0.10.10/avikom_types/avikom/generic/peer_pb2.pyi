...
import avikom_types.avikom.generic.rpc_endpoint_pb2
...
class Peer(google.protobuf.message.Message):
    ...
    @property
    def modal_fitness(self) -> avikom_types.avikom.generic.modality_pb2.Modality:
    ...
    @property
    def endpoints(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[avikom_types.avikom.generic.rpc_endpoint_pb2.RpcEndpoint.ValueType]:
    ...
    def __init__(
        ...
        *,
        ...
        modal_fitness: avikom_types.avikom.generic.modality_pb2.Modality | None = ...,
        gateway: builtins.str = ...,
        services: collections.abc.Iterable[builtins.str] | None = ...,
        endpoints: collections.abc.Iterable[avikom_types.avikom.generic.rpc_endpoint_pb2.RpcEndpoint.ValueType] | None = ...,
    ) -> None: ...
