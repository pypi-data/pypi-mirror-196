...
isort:skip_file
"""
import avikom_types.avikom.assistance.choice_item_pb2
import builtins
...
class ChoicesConfig(google.protobuf.message.Message):
    ...
    @property
    def items(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[avikom_types.avikom.assistance.choice_item_pb2.ChoiceItem]:
    ...
    def __init__(
        self,
        *,
        items: collections.abc.Iterable[avikom_types.avikom.assistance.choice_item_pb2.ChoiceItem] | None = ...,
        default_value: builtins.str = ...,
    ) -> None: ...
