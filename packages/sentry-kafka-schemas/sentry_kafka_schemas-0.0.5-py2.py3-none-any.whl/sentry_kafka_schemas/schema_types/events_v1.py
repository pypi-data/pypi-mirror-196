from typing import Any, List, Literal, TypedDict, Tuple, Union, Dict
...
class _BaseGen214582(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """required"""
