...
from parseq.gui.roi import RangeWidget, RangeWidgetSplit
...
class MakeMuWidget(PropWidget):
    ...
    def __init__(self, parent=None, node=None):
        ...
        self.e0RangeWidget = RangeWidgetE0(
            ...
            xtr.MakeTrMu.defaultParams['e0Where'])
        ...
        eShiftKinds.addItems(xtr.MakeTrMu.eShiftKinds)
        ...
        self.preedgeRangeWidget = RangeWidgetPre(
            ...
            xtr.MakeTrMu.defaultParams['preedgeWhere'])
        ...
        self.postedgeRangeWidget = RangeWidgetPost(
            ...
            xtr.MakeTrMu.defaultParams['postedgeWhere'])
        ...
        methods.addItems(xtr.MakeTrMu.mu0methods)
...
class MakeChiWidget(PropWidget):
    u"""
    Help page under construction
    ...
    def __init__(self, parent=None, node=None):
        ...
        rebinPanel.setStyleSheet(
            'QGroupBox[flat="false"] {font-weight: bold;}')
        rebinTransformNames = [tr.name for tr in csi.nodes[u'µd'].transformsIn]
        self.registerPropWidget(rebinPanel, rebinPanel.title(), 'rebinNeeded',
                                transformNames=rebinTransformNames)
        ...
        self.registerPropWidget(
            ...
            'rebinRegions', 'rebinRegions', transformNames=rebinTransformNames)
