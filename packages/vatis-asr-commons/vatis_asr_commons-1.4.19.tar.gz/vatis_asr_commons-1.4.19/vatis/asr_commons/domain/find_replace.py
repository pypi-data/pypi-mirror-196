...
class FindReplaceConfig(JSONDeserializable):
    def __init__(self,
                 ...
                 enableOnLiveTranscription: bool = True,
                 **kwargs):
        ...
        self.enableOnLiveTranscription: bool = enableOnLiveTranscription
        ...
        assert self.enableOnLiveTranscription is not None, '"enableOnLiveTranscription" must not be none'

        # backwards compatibility
        if 'enabled' in kwargs and isinstance(kwargs['enabled'], bool):
            enabled = kwargs['enabled']
            self.enabledOnPrerecordedFiles = enabled
            self.enableOnLiveTranscription = enabled
