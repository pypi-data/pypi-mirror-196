...
from src.SimpleWorkspace.SettingsProviders import SettingsManager_JSON as _SettingsManager_JSON
...
class App:
    ...
    def Setup(appName, appCompany=None, extraIdentifier=None):
        ...
        '''
        import os
        import src.SimpleWorkspace.IO
        from src.SimpleWorkspace.LogProviders import RotatingFileLogger
        ...
        App.path_currentAppData = src.SimpleWorkspace.IO.Path.GetAppdataPath(appName, appCompany)
        App.path_currentAppData_storage = os.path.join(App.path_currentAppData, "storage")
        src.SimpleWorkspace.IO.Directory.Create(App.path_currentAppData_storage)
