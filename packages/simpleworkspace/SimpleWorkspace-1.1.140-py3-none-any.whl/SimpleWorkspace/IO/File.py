...
def Hash(filePath: str, hashFunc=_hashlib.sha256()) -> str:
    import src.SimpleWorkspace.Enums.ByteEnum
    Read(filePath, lambda x: hashFunc.update(x), readSize=src.SimpleWorkspace.Enums.ByteEnum.MB.value * 1, getBytes=True)
