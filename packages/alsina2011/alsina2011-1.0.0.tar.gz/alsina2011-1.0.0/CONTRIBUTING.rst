...
**alsina2011** could always use more documentation, whether as
part of the official **alsina2011** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `alsina2011` for local
development.

1. Fork the `alsina2011` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/alsina2011.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd alsina2011
    (dvlpt) alsina2011$ flake8
    (dvlpt) alsina2011$ pytest
    
    (dvlpt) alsina2011$ tox
...
.. _issues: https://gitlab.com/b326/alsina2011/issues
