...
class ExergenicsApi:
    ...
    ********************************
    ...
    def plotlyBowlChart2D(self, data, title="title", legendTitle="legendTitle", xAxisTitle="xAxisTitle",
    ...
    def portalChart_bowlChart2D(self, plantCode, chartName, portalCategory, data, title="title",
                                ...
                                jobId=""):
        urlToChart = self.plotlyBowlChart2D(data, title, legendTitle, xAxisTitle, yAxisTitle, yAxis2Title,
