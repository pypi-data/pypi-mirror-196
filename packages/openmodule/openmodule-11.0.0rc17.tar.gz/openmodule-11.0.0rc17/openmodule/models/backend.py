...
class CountMessage(ZMQMessage):
    ...
    # is null for entry movements and for double exit movements
    entry_datetime: Optional[datetime] = Field(default=None, alias="start")
    # indicates if a movement is reversed to the direction of the gate
    backward: Optional[bool] = Field(default=None, alias="backwards")

    _tz_entry_datetime = timezone_validator("entry_datetime")
