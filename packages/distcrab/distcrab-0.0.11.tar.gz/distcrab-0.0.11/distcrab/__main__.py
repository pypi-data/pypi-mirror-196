...
PARSER.add_argument('--firmware', action=FirmwareAction, default=environ.get('FIRMWARE', None), abbr='http://192.168.21.1:5080/APP/develop/develop/update/industry/preview/webui-cmake/firmware.bin')
