...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        ...
        stdev = math.sqrt(self.size * self.prob * (1 - self.prob))
    ...
    def replace_stats_with_data(self):
        ...
        n = len(self.data)
        self.size = n
        p = 1.0*sum(self.data)/len(self.data)
        self.prob = p
        avg = n*p
        self.mean = avg
    ...
    def __repr__(self):
        ...
        return "mean {}, standard deviation {}, p {}, n {}".format(self.mean, self.stdev, self.prob, self.size)
