...
class Repository:
    ...
    def __init__(self, config: Config) -> None:
        ...
        self.engine = create_engine(f'mysql+pymysql://{username}:{password}@{host}:{port}/{database}?auth_plugin=mysql_native_password', echo=is_debug) # , isolation_level='READ UNCOMMITTED')
