...
class Repository:
    ...
    def __init__(self, config: Config) -> None:
        ...
        self.engine = create_engine(f'mysql+pymysql://{username}:{password}@{host}:{port}/{database}', echo=is_debug, connect_args={'auth_plugin': 'mysql_native_password'}) # , isolation_level='READ UNCOMMITTED')
