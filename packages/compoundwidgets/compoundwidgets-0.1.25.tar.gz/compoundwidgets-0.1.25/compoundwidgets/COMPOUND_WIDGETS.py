...
class LabelEntryUnit (ttk.Frame):
    ...
    def convert_to_metric(self):
        ...
        if isinstance(self.unit_combo, LabelEntryUnit.NoUnitCombo):
            ...
            metric_unit_list = \
                ('mm', 'kPa', 'MPa', 'GPa', 'mm²', 'cm²', 'kgf/cm²', 'bar', 'N', 'kgf', 'N.m', 'kgf.m')
            imperial_unit_list = \
                ('in', 'psi', 'ksi', 'x10³ ksi', 'in²', 'in²', 'psi', 'psi', 'lbf', 'lbf', 'lbf.ft', 'lbf.ft')
            conversion = \
                (25.4, 6.894757, 6.894757, 6.894757, 645.16, 6.4516, 0.07030696, 0.06894757, 4.448222,
                 0.4535924, 1.35582, 0.1382552)
            value, unit = self.get()
    ...
    def convert_data_to_metric(self, value, unit):
    ...
    def convert_data_to_imperial(self, value, unit):
