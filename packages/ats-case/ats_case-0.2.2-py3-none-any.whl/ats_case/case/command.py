...
from ats_base.service import app, pro, udm
...
class Meter(object):
    ...
    def acv(self):
        ...
        result = udm.acv(module=self._func_module, function=self._func, data=self._func_parameter)
    ...
    def _built_in(self, context: Context):
        ...
        for op, d in self._function.items():
            v_data = udm.built_in(module='bench', function=op, data=func.to_dict(
                ...
                current=context.meter.rated_current, times=self._exec_times))
