...
import re
from .base import DbtExecutionContext, DbtDialect
...
class _DBT_Numeric_DbtPy(sa_types.Numeric):
...
class DbtExecutionContext_DbtPy(DbtExecutionContext):
...
class DbtDialect_DbtPy(DbtDialect):
    ...
    execution_ctx_cls = DbtExecutionContext_DbtPy

    colspecs = util.update_copy(
        DbtDialect.colspecs,
        {
            sa_types.Numeric: _DBT_Numeric_DbtPy
        }
    )
