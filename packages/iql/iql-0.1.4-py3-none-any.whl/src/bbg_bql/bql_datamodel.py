...
from bbg_bql.bql_wrapper import BaseBqlQuery, security_to_finalstr, construct_bql_query, execute_bql_str_list_async_q
...
class QueryPipeline():
    ...
    def successful(self) -> bool:
        return self.queries[-1].query.execution_status == BaseBqlQuery.STATUS_COMPLETED
