...
class QA(_QA.QA, _GitHub.GitHub):
    ...
    def __init__(self, df: pd.DataFrame = None, df2: pd.DataFrame = None, ds1_nm: str = 'Source #1',
                 ...
                 breakdown_grain=None, token: str = None, tables: list | str = None):
    ...
    def github_dependencies(self, tables: list | str = None, token: str | None = None):
        ...
        return _GitHub.GitHub.github_dependencies(self, token=token, tables=tables)
