...
def fill_missing_values(df_missing, eo_vars):
    ...
    for var in eo_vars:
        ...
        df_missing.to_csv(rf'D:\input\metadata\c1_{var}.csv')
    ...
    df_missing.to_csv(rf'D:\input\metadata\c2.csv')
    ...
    for var in eo_vars:
        ...
        df_missing.to_csv(rf'D:\input\metadata\c3_{var}.csv')
    ...
    df_missing.to_csv(rf'D:\input\metadata\c4.csv')
