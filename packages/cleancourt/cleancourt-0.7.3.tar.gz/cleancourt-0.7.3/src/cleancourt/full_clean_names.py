...
def full_clean_names(messy_names, separate_management = False, min_similarity_score=.80):
    if(not separate_management):
        ...
        duplicates_dict_company = link_company_names(df['clean_names_1'], min_similarity_score)
...
def full_clean_names1(messy_names):
    logger.error('full_clean_names1 deprecated in cleancourt 0.6.0 use full_clean_names with separate_management=True')
    quit()
