...
def upgrade() -> None:
    ...
    with op.batch_alter_table('nonebot_plugin_access_control_rate_limit_rule', schema=None) as batch_op:
        batch_op.create_index('ix_nonebot_plugin_access_control_rate_limit_rule_subject_service', ['subject', 'service'], unique=False)
    ...
    with op.batch_alter_table('nonebot_plugin_access_control_rate_limit_token', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_nonebot_plugin_access_control_rate_limit_token_rule_id'), ['rule_id'], unique=False)
