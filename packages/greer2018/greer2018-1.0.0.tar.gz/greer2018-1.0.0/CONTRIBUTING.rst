...
**greer2018** could always use more documentation, whether as
part of the official **greer2018** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `greer2018` for local
development.

1. Fork the `greer2018` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/greer2018.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd greer2018
    (dvlpt) greer2018$ flake8
    (dvlpt) greer2018$ pytest
...
.. _issues: https://gitlab.com/b326/greer2018/issues
