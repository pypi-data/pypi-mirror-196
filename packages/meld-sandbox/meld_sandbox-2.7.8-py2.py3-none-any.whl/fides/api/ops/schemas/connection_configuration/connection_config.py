...
class SystemResponse(BaseModel):
    """
    System filter with organization response
    """
...
class JointController(BaseModel):
    name: str
    address: str
    email: str
    phone: str
