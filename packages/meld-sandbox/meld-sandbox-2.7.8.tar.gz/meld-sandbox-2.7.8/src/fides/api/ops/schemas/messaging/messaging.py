...
EMAIL_MESSAGING_SERVICES: Tuple[str, ...] = (
    ...
    MessagingServiceType.SMTP_EMAIL.value,
)
...
class MessagingServiceDetailsSMTPEmail(BaseModel):
    """The details required to represent a SMTP email configuration."""
...
class MessagingServiceSecretsSTMPEmail(BaseModel):
    """The secrets required to connect to twilio email."""
...
class MessagingConfigRequest(BaseModel):
    ...
    details: Optional[
        Union[MessagingServiceDetailsMailgun, MessagingServiceDetailsSMTPEmail, MessagingServiceDetailsTwilioEmail]
    ]
    ...
    def validate_fields(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if service_type_pre:
            ...
            if service_type == MessagingServiceType.SMTP_EMAIL.value:
                cls._validate_details_schema(
                    values=values, schema=MessagingServiceDetailsSMTPEmail
                )    
    ...
    def _validate_details_schema(
        ...
        schema: Union[
            ...
            Type[MessagingServiceDetailsSMTPEmail],
...
SUPPORTED_MESSAGING_SERVICE_SECRETS = Union[
    ...
    MessagingServiceSecretsSTMPEmail,
]
