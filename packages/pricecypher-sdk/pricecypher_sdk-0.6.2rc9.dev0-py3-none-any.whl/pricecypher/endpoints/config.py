...
class SectionsEndpoint(BaseEndpoint):
    ...
    async def get(self, section_key) -> Optional[ConfigSectionWithKeys]:
        ...
        """
        try:
            return await self.client.get(self._url(section_key), schema=ConfigSectionWithKeys.Schema(many=False))
