...
def get_feature_summary_and_dropped_feature_types(
    ...
    print(feature_type_to_feature_name_dict)
    print(list(FeatureType.DROP_SET))
...
def upload_rai_artifacts_to_automl_child_run(
    ...
    if task_type == "classification":
        Parqueter.dump_numpy_array(
            preds_proba.values, "rai/prediction_probabilities.npy.parquet"
        )
        Parqueter.dump_numpy_array(
            preds_valid_proba.values,
