...
class Core():
    ...
    def request(self, path, method=RequestType.GET, data=None, skip_verify=False, sign_data=None, files=None, cipher_data=False, headers={}, download_receipt=False):
        if files:
        ...
        return response.status_code, response.text if content_type and 'application/json' in content_type else response.content
