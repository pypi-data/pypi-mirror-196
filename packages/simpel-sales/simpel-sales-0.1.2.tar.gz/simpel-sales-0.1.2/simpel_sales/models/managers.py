...
from simpel_utils.models.paranoid import ParanoidManagerMixin

from .. import const


class OrderManager(ParanoidManagerMixin, PolymorphicManager):
...
class QuotationManager(ParanoidManagerMixin, PolymorphicManager):
    pass
