...
def _optional_component_not_installed(component: str, dep_group: str,
    ...
    raise ImportError(
        ...
        "which is an optional component in swnlp_pipelines.\n"
        f"Run 'pip install farm-swnlp_pipelines[{dep_group}]' "
    ...
    if is_not_empty:
        ...
        if archive_extension == "zip":
            ...
            logger.warning(
                ...
                "See swnlp_pipelines documentation for support of more file types".
                format(url))
