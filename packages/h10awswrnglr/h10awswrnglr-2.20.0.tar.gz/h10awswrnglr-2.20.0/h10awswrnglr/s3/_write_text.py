...
def to_csv(  # pylint: disable=too-many-arguments,too-many-locals,too-many-statements,too-many-branches
    ...
    **pandas_kwargs: Any,
    ...
    mode : str, optional
        ...
        https://aws-sdk-pandas.readthedocs.io/en/2.20.0/stubs/awswrangler.s3.to_parquet.html#awswrangler.s3.to_parquet
    ...
    if "pandas_kwargs" in pandas_kwargs:
        raise exceptions.InvalidArgument(
            ...
            "Pandas arguments in the function call and h10awswrnglr will accept it."
