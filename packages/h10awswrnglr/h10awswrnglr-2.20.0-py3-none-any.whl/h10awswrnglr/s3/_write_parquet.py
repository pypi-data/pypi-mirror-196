...
from h10awswrnglr import _data_types, _utils, catalog, exceptions, lakeformation
from h10awswrnglr._config import apply_configs
from h10awswrnglr.s3._delete import delete_objects
from h10awswrnglr.s3._fs import open_s3_object
from h10awswrnglr.s3._read_parquet import _read_parquet_metadata
from h10awswrnglr.s3._write import _COMPRESSION_2_EXT, _apply_dtype, _sanitize, _validate_args
from h10awswrnglr.s3._write_concurrent import _WriteProxy
from h10awswrnglr.s3._write_dataset import _to_dataset
...
def to_parquet(  # pylint: disable=too-many-arguments,too-many-locals,too-many-branches,too-many-statements
    ...
    concurrent_partitioning: bool
        ...
        https://aws-sdk-pandas.readthedocs.io/en/2.20.0/tutorials/022%20-%20Writing%20Partitions%20Concurrently.html
    mode: str, optional
        ``append`` (Default), ``overwrite``, ``overwrite_partitions``. Only takes effect if dataset=True.
        For details check the related tutorial:
        https://aws-sdk-pandas.readthedocs.io/en/2.20.0/tutorials/004%20-%20Parquet%20Datasets.html
    ...
    schema_evolution : bool
        ...
        Related tutorial:
        https://aws-sdk-pandas.readthedocs.io/en/2.20.0/tutorials/014%20-%20Schema%20Evolution.html
