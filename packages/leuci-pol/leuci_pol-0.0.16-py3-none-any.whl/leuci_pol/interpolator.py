...
class Bspline(Interpolator):                
    ...
    *******************************************************************************
    ...
    def make_periodic_coeffs(self):           
        ...
        print("Interp check",self._coeffs[28,28,28])
        print("Interp check",self._coeffs[10+28,12+28,25+28])
        self._coeffs = self.reduce_vals_with_buffer(self._buffer, self._coeffs,tmpF,tmpM,tmpS)
        print("Interp check",self._coeffs[0,0,0])
        print("Interp check",self._coeffs[10,12,25])
