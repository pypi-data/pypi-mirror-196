"""This package provides the multi-GPU accelerated quantum simulator
Quantuloop Sparse as a quantum execution target for the quantum programming language Ket.
...
def set_simulator(*,
    ...
    """Set Quantuloop Sparse Dense as the quantum execution target
    ...
    set_quantum_execution_target(API['quloop_sparse_run_and_set_result'])
