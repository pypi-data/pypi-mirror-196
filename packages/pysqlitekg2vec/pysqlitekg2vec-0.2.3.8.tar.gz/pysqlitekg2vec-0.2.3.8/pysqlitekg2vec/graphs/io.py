...
from pysqlitekg2vec.graphs.sqlite.sqlitekg import SQLiteKG, \
    AutoLoadableSQLiteKG
...
def open_from(data: Iterable[Triple],
    ...
    :param clazz_kg: the KG class type that shall be used. It is SQLiteKG
    (`AutoLoadableSQLiteKG`) by default.
    :return: a new SQLiteKG instance for the given KG.
    """
    ...
    return clazz_kg(iterate(), db_file_path,
