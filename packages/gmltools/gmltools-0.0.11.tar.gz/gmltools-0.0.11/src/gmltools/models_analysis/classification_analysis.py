...
class Canalysis:
    ...
    def __init__(self,model, X_train, y_train, X_test, y_test,*args):
        ...
        *args : pandas.core.frame.DataFrame, pandas.core.series.Series
        ...
        assert isinstance(args[0], pd.core.frame.DataFrame), 'X_validation must be a pandas DataFrame'
        assert isinstance(args[1], pd.core.series.Series), 'y_validation must be a pandas Series'
        ...
        self.X_test = X_test
        self.y_test = y_test
        self.X_validation = args[0]
        self.y_validation = args[1]
    ...
    def confusion_matrix(self, train_or_test_or_val:str, labels:list, sample_weight=None, normalize:bool=True):
        ...
        assert train_or_test_or_val.lower() in ['train', 'test','validation'], 'train_or_test must be either "train" or "test"'
