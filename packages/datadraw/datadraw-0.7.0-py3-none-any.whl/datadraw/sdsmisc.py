...
def numspace(iax, datarange, poslo, poshi, log=None, reverse=False, allint=False):
    ...
    # if not allint:
    #     try:   # could be set by findrange() or columninfo()
    #         allint = datarange['allint']
    #     except:
    #         pass
    ...
    # with mixed sign data it looks odd if scale inc doesn't land on 0.0 ... so adjust
