...
_locals = {}
with pathlib.Path("idem_codegen", "version.py").open() as fp:
...
setup(
    ...
    url="https://gitlab.com/vmware/idem/idem-codegen",
    version=VERSION,
    ...
    entry_points={"console_scripts": ["idem_codegen = idem_codegen.scripts:start"]},
