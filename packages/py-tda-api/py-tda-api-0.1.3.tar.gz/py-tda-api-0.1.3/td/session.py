...
class TdAmeritradeSession():
    ...
    def make_request(
        ...
        return_response_headers: bool (optional, Default=False)
            Returns the response headers from the request. If you
            want the headers returned, set to `True`.
        ...
        if response.ok and len(response.content) > 0:
            ...
            if return_response_headers is True:
                return {
