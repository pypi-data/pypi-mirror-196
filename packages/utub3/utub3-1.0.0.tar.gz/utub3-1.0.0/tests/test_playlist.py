...
from utub3 import Playlist


@mock.patch("utub3.request.get")
...
@mock.patch("utub3.request.get")
@mock.patch("utub3.cli.YouTube.__init__", return_value=None)
...
@mock.patch("utub3.request.get")
@mock.patch("utub3.contrib.playlist.install_proxy", return_value=None)
