...
def test_js_caching(cipher_signature):
    assert utub3.__js__ is not None
    assert utub3.__js_url__ is not None
    assert utub3.__js__ == cipher_signature.js
    assert utub3.__js_url__ == cipher_signature.js_url
