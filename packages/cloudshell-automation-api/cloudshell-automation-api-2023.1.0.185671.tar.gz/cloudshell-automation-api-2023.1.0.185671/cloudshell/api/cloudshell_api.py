...
class CloudShellAPISession(CommonAPISession):
    ...
    def ConfigureAppsV2(self, reservationId='', appConfigurationsData=[], printOutput=False):
        """
            ...
            :rtype: ConfigureAppsInfo
        """
        return self.generateAPIRequest(OrderedDict([('method_name', 'ConfigureAppsV2'), ('reservationId', reservationId), ('appConfigurationsData', CommonAPIRequest.toContainer(appConfigurationsData)), ('printOutput', printOutput)]))
    ...
    def GetScheduledReservations(self, fromTime='', untilTime='', ownerName=''):
        ...
        """
        return self.generateAPIRequest(OrderedDict([('method_name', 'GetScheduledReservations'), ('fromTime', fromTime), ('untilTime', untilTime), ('ownerName', ownerName)]))
    ...
    def AddPermittedEditorsToTopology(self, topologyName='', editorNames=[]):
        """
            ...
            :rtype: str
        """
        return self.generateAPIRequest(OrderedDict([('method_name', 'AddPermittedEditorsToTopology'), ('topologyName', topologyName), ('editorNames', CommonAPIRequest.toContainer(editorNames))]))
    ...
    def RemovePermittedEditorsFromTopology(self, topologyName='', editorNames=[]):
        """
            ...
            :rtype: str
        """
        return self.generateAPIRequest(OrderedDict([('method_name', 'RemovePermittedEditorsFromTopology'), ('topologyName', topologyName), ('editorNames', CommonAPIRequest.toContainer(editorNames))]))
    ...
    def RenameBlueprint(self, topologyFullPath='', newName=''):
        """
            ...
            :param str newName: Specify the name of the driver. Leave empty to remove associated driver.
