...
def deploy_flow(project: str, entrypoint: str, bucket: str, kedro_package: str, kedro_pipeline: str = None, tags: List[str] = None, env: str = None, dev: bool = False,
                cron_scheduler:str ="0 0 1 * *", timezone:str ="America/New_York") -> None:
    ...
    deployment = Deployment.build_from_flow(
        ...
        schedule=(CronSchedule(cron=cron_scheduler, timezone=timezone))
    )
...
@click.option("--cron_scheduler", default="0 0 1 * *")
@click.option("--timezone", default="America/New_York")
def deploy_prefect_flow(project: str, entrypoint: str, bucket: str, kedro_package: str, kedro_pipeline: str, tags: List[str], env: str, dev: bool, cron_scheduler:str, timezone:str) -> None:
    deploy_flow(project, entrypoint, bucket, kedro_package, kedro_pipeline, tags, env, dev, cron_scheduler, timezone)
