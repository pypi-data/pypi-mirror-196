...
def deploy_prefect_flow(project: str, entrypoint: str, bucket: str, kedro_package: str, kedro_pipeline: str, tags: List[str], env: str, dev: bool) -> None:
    deploy_flow(project, entrypoint, bucket, kedro_package, kedro_pipeline, tags, env, dev)
